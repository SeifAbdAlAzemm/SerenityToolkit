...
function addCustomAttribute(type, attr3) {
  let typeInfo = ensureTypeInfo(type);
  if (!typeInfo.customAttributes)
    typeInfo.customAttributes = [attr3];
  else
    typeInfo.customAttributes.push(attr3);
}
  ...
  do {
    ...
    if (attrs) {
      for (var i = attrs.length - 1; i >= 0; i--) {
        let attr3 = attrs[i];
        if (attr3 != null && isInstanceOfType(attr3, attrType))
          return attr3;
      }
    }
...
function getCustomAttributes(type, attrType, inherit = true) {
  ...
  do {
    ...
    if (attrs) {
      for (var i = attrs.length - 1; i >= 0; i--) {
        let attr3 = attrs[i];
        if (attr3 && (allTypes || attrType && isInstanceOfType(attr3, attrType))) {
          result.push(attr3);
        }
      }
    }
...
function setElementReadOnly(elements, value) {
  ...
  for (var i = 0; i < elements.length; i++) {
    ...
    const attr3 = el.tagName == "SELECT" || type === "radio" || type === "checkbox" ? "disabled" : "readonly";
    value ? el.setAttribute(attr3, attr3) : el.removeAttribute(attr3);
  }
}
...
((Fluent6) => {
  ...
  Fluent6.isVisibleLike = isVisibleLike;
  __name(isVisibleLike, "isVisibleLike");
  ...
  Fluent6.toClassName = toClassName;
  __name(toClassName, "toClassName");
  function isInputLike(element) {
    return isInputTag(element == null ? void 0 : element.nodeName);
  }
  Fluent6.isInputLike = isInputLike;
  __name(isInputLike, "isInputLike");
  Fluent6.inputLikeSelector = "input,select,textarea,button";
  function isInputTag(tag) {
    return /^(?:input|select|textarea|button)$/i.test(tag);
  }
  Fluent6.isInputTag = isInputTag;
  __name(isInputTag, "isInputTag");
  ...
  Fluent6.isDefaultPrevented = isDefaultPrevented;
  ...
  Fluent6.eventProp = eventProp;
  __name(eventProp, "eventProp");
})(Fluent || (Fluent = {}));
...
__name(extractNode, "extractNode");
...
Object.defineProperty(Fluent.prototype, "length", { get: /* @__PURE__ */ __name(function() {
  return this.el ? 1 : 0;
}, "get") });
Object.defineProperty(Fluent.prototype, 0, { get: /* @__PURE__ */ __name(function() {
  return this.el;
}, "get") });
Object.defineProperty(Fluent.prototype, Symbol.iterator, { get: /* @__PURE__ */ __name(function() {
...
__name(iconClassName, "iconClassName");

// ../../node_modules/.pnpm/jsx-dom@8.1.5/node_modules/jsx-dom/min/index.js
...
__name(isComponentClass, "isComponentClass");
...
__name(isVisibleChild, "isVisibleChild");
...
function Fragment(attr3) {
  const fragment = document.createDocumentFragment();
  appendChild(attr3.children, fragment);
  return fragment;
}
__name(Fragment, "Fragment");
function initComponentClass(Class, attr3, children) {
  attr3 = __spreadProps(__spreadValues({}, attr3), {
    children
  });
  const instance = new Class(attr3);
  const node = instance.render();
  if ("ref" in attr3) {
    attachRef(attr3.ref, instance);
  }
  return node;
}
__name(initComponentClass, "initComponentClass");
function jsx(tag, _ref) {
  let _a68 = _ref, { children } = _a68, attr3 = __objRest(_a68, ["children"]);
  let node;
  if (isString(tag)) {
    node = attr3.namespaceURI ? document.createElementNS(attr3.namespaceURI, tag) : document.createElement(tag);
    attributes(attr3, node);
    appendChild(children, node);
    if (node instanceof window.HTMLSelectElement && attr3.value != null) {
      if (attr3.multiple === true && Array.isArray(attr3.value)) {
        const values = attr3.value.map((value) => String(value));
        node.querySelectorAll("option").forEach(
          (option) => option.selected = values.includes(option.value)
        );
      } else {
        node.value = attr3.value;
      }
    }
    attachRef(attr3.ref, node);
  } else if (isFunction(tag)) {
    if (isObject(tag.defaultProps)) {
      attr3 = __spreadValues(__spreadValues({}, tag.defaultProps), attr3);
    }
    node = isComponentClass(tag) ? initComponentClass(tag, attr3, children) : tag(__spreadProps(__spreadValues({}, attr3), {
      children
    }));
  } else {
...
__name(attachRef, "attachRef");
function appendChild(child, node) {
  if (isArrayLike2(child)) {
...
__name(appendChildToNode, "appendChildToNode");
...
__name(attr, "attr");
function attributes(attr3, node) {
  for (const key of keys(attr3)) {
    attribute(key, attr3[key], node);
  }
  return node;
}
__name(attributes, "attributes");

// src/base/dialogs.tsx
var _Dialog = class _Dialog {
  ...
  createBSModal(opt) {
    var _a68, _b, _c;
    const header = /* @__PURE__ */ jsx("div", { class: "modal-header", children: /* @__PURE__ */ jsx("h5", { class: "modal-title" }) });
    let bs5 = isBS5Plus();
    if (opt.closeButton) {
      const closeButton = /* @__PURE__ */ jsx("button", { type: "button", class: bs5 ? "btn-close" : "close", "aria-label": DialogTexts.CloseButton, children: !bs5 && /* @__PURE__ */ jsx("span", { "aria-hidden": true, children: "\u2715" }) });
    ...
    const footer = /* @__PURE__ */ jsx("div", { class: "modal-footer" });
    if (opt.buttons) {
      this.createBSButtons(footer, opt.buttons);
    }
    const modal = document.body.appendChild(
      /* @__PURE__ */ jsx("div", { class: ["modal", opt.dialogClass, opt.fade && "fade"], tabIndex: -1, children: /* @__PURE__ */ jsx("div", { class: [
        "modal-dialog",
      ...
      ], children: /* @__PURE__ */ jsx("div", { class: "modal-content", children: [
        header,
        this.el,
        footer
      ] }) }) })
    ...
    if (bs5 && bootstrap.Modal) {
      ...
      (_c = (_b = (_a68 = getjQuery()) == null ? void 0 : _a68(modal)) == null ? void 0 : _b.modal) == null ? void 0 : _c.call(_b, modalOpt);
    }
    ;
  }
  createPanel(opt) {
    const panel = /* @__PURE__ */ jsx("div", { class: ["s-Panel", "hidden", opt.dialogClass], children: /* @__PURE__ */ jsx("div", { class: "panel-titlebar", children: [
      /* @__PURE__ */ jsx("div", { class: "panel-titlebar-text" }),
      opt.closeButton && /* @__PURE__ */ jsx("button", { type: "button", class: "panel-titlebar-close", onClick: this.close.bind(this, null) })
    ] }) });
    ...
    if (opt.buttons) {
      this.createBSButtons(panel.appendChild(/* @__PURE__ */ jsx("div", { class: "panel-footer" })), opt.buttons);
    }
  }
  createUIDialog(opt) {
    var _a68;
...
__name(uiAndBSButtonNoConflict, "uiAndBSButtonNoConflict");
...
__name(dialogButtonToBS, "dialogButtonToBS");
...
__name(dialogButtonToUI, "dialogButtonToUI");
...
__name(okDialogButton, "okDialogButton");
...
__name(yesDialogButton, "yesDialogButton");
...
__name(noDialogButton, "noDialogButton");
...
__name(cancelDialogButton, "cancelDialogButton");
var DialogTexts;
((DialogTexts2) => {
  const defaultTxt = {
    AlertTitle: "Alert",
...
__name(getDialogNode, "getDialogNode");
...
__name(getDialogEventsNode, "getDialogEventsNode");
...
__name(getDialogContentNode, "getDialogContentNode");
...
__name(getMessageBodyHtml, "getMessageBodyHtml");
...
function alertDialog(message, options) {
  return createMessageDialog({
    ...
    getButtons: /* @__PURE__ */ __name(() => [okDialogButton({ cssClass: "btn-danger" })], "getButtons"),
    native: /* @__PURE__ */ __name((msg) => {
      alert(msg);
      return "ok";
    }, "native")
  });
...
function informationDialog(message, onOk, options) {
  return createMessageDialog({
    ...
    getButtons: /* @__PURE__ */ __name(() => [okDialogButton({ click: onOk, cssClass: "btn-info" })], "getButtons"),
    native: /* @__PURE__ */ __name((msg) => {
      alert(msg);
...
__name(informationDialog, "informationDialog");
function successDialog(message, onOk, options) {
  return createMessageDialog({
    ...
    getButtons: /* @__PURE__ */ __name(() => [okDialogButton({ click: onOk, cssClass: "btn-success" })], "getButtons"),
    native: /* @__PURE__ */ __name((msg) => {
      alert(msg);
      onOk == null ? void 0 : onOk();
      return "ok";
...
__name(successDialog, "successDialog");
function warningDialog(message, options) {
  return createMessageDialog({
    ...
    getButtons: /* @__PURE__ */ __name(() => [okDialogButton({ cssClass: "btn-warning" })], "getButtons"),
    native: /* @__PURE__ */ __name((msg) => {
      alert(msg);
      return "ok";
    }, "native")
...
__name(warningDialog, "warningDialog");
function iframeDialog(options) {
  ...
  return new Dialog({
    ...
    providerOptions: /* @__PURE__ */ __name((type) => {
      if (type == "uidialog") {
        return {
          width: "60%",
          height: "400"
...
__name(iframeDialog, "iframeDialog");
var modalShow = /* @__PURE__ */ __name((e) => {
  var _a68;
...
var modalShown = /* @__PURE__ */ __name((e) => {
  var _a68;
  var body = (_a68 = Dialog.getInstance(e.target)) == null ? void 0 : _a68.getContentNode();
  if (body) {
...
var modalHide = /* @__PURE__ */ __name((e) => {
  var _a68;
  var body = (_a68 = Dialog.getInstance(e.target)) == null ? void 0 : _a68.getContentNode();
  if (body) {
...
var modalHidden = /* @__PURE__ */ __name((e) => {
  var _a68;
  var body = (_a68 = Dialog.getInstance(e.target)) == null ? void 0 : _a68.getContentNode();
  if (body) {
...
__name(installBsModalEventPropagation, "installBsModalEventPropagation");
...
__name(uninstallBsModalEventPropagation, "uninstallBsModalEventPropagation");
...
var Invariant = {
  ...
  stringCompare: /* @__PURE__ */ __name((a, b) => a < b ? -1 : a > b ? 1 : 0, "stringCompare")
};
var Culture = {
  decimalSeparator: ".",
  groupSeparator: ",",
...
(function() {
  var _a68, _b, _c, _d;
  let lang = typeof document !== "undefined" ? (_a68 = document.documentElement) == null ? void 0 : _a68.lang : void 0;
  if (lang == "")
    lang = void 0;
  if (lang !== void 0) {
    try {
  ...
  if (typeof document !== "undefined" && ((_d = k = (_c = (_b = document.querySelector("script#ScriptCulture")) == null ? void 0 : _b.textContent) == null ? void 0 : _c.trim()) == null ? void 0 : _d.length)) {
    var sc = JSON.parse(k);
...
__name(insertGroupSeperator, "insertGroupSeperator");
var _formatRE = /\{\{|\}\}|\{[^\}\{]+\}/g;
...
__name(_formatString, "_formatString");
...
__name(stringFormatLocale, "stringFormatLocale");
...
__name(_formatObject, "_formatObject");
var round = /* @__PURE__ */ __name((num, d) => {
  ...
  return +(Math.round(num + ep) + em) * s;
}, "round");
var trunc = /* @__PURE__ */ __name((n) => n != null ? n > 0 ? Math.floor(n) : Math.ceil(n) : null, "trunc");
...
function formatISODateTimeUTC(d) {
  if (d == null)
    return "";
  let zeropad = /* @__PURE__ */ __name(function(num) {
    return (num < 10 ? "0" : "") + num;
  }, "zeropad");
...
__name(formatISODateTimeUTC, "formatISODateTimeUTC");
...
((ErrorHandling3) => {
  ...
  __name(showServiceError, "showServiceError");
  ...
  __name(runtimeErrorHandler, "runtimeErrorHandler");
  ...
  __name(isDevelopmentMode, "isDevelopmentMode");
  ...
  __name(unhandledRejectionHandler, "unhandledRejectionHandler");
...
__name(resolveServiceUrl, "resolveServiceUrl");
...
__name(getServiceOptions, "getServiceOptions");
...
__name(requestStarting, "requestStarting");
...
__name(requestFinished, "requestFinished");
        ...
        try {
          if (xhr.status !== 200) {
            ...
            return reject(reason(
              `Service call to '${url}' resulted in HTTP ${xhr.status} error: ${xhr.statusText}!`,
              "http-error",
...
__name(serviceCall, "serviceCall");
...
__name(handleXHRError, "handleXHRError");
...
__name(getScriptDataHash, "getScriptDataHash");
var scriptDataHooks = {
  /**
   ...
   */
  fetchScriptData: void 0
};
var fetchPromises = {};
function fetchScriptData(name) {
  var _a68, _b;
  const hookResult = (_a68 = scriptDataHooks.fetchScriptData) == null ? void 0 : _a68.call(scriptDataHooks, name);
  if (hookResult != void 0) {
    return Promise.resolve(hookResult).then((data) => {
      if ((name == null ? void 0 : name.startsWith("Lookup.")) && (data == null ? void 0 : data.Items) && !data.items && !data.itemById)
        return new Lookup(hookResult.Params, hookResult.Items);
      return data;
    });
  }
  let key = name + "?" + ((_b = getScriptDataHash(name)) != null ? _b : "");
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            if (!response.ok)
              handleScriptDataError(name, response.status, (_b2 = response.statusText) != null ? _b2 : "");
...
__name(fetchScriptData, "fetchScriptData");
...
function ensureScriptDataSync(name, dynJS) {
  var _a68, _b;
  var data = peekScriptData(name);
  if (data != null)
    return data;
  data = (_a68 = scriptDataHooks.fetchScriptData) == null ? void 0 : _a68.call(scriptDataHooks, name, true, dynJS);
  if (data !== void 0) {
    if (isPromiseLike(data))
      throw new Error("fetchScriptData hook must return data synchronously when sync is true.");
    if (name.startsWith("Lookup.") && (data == null ? void 0 : data.Items))
      data = new Lookup(data.Params, data.Items);
    setScriptData(name, data);
    return data;
  }
  var url = resolveUrl(dynJS ? "~/DynJS.axd/" : "~/DynamicData/") + name + (dynJS ? ".js" : "") + "?v=" + ((_b = getScriptDataHash(name)) != null ? _b : (/* @__PURE__ */ new Date()).getTime());
  var xhr = new XMLHttpRequest();
...
__name(setRegisteredScripts, "setRegisteredScripts");
...
__name(setScriptData, "setScriptData");

// src/base/authorization.ts
var andOrRegex = /[|&]/;
var Authorization;
((Authorization2) => {
  ...
  __name(hasPermissionAsync, "hasPermissionAsync");
  ...
  __name(isPermissionInSet, "isPermissionInSet");
  ...
  __name(validatePermission, "validatePermission");
  ...
  __name(validatePermissionAsync, "validatePermissionAsync");
...
var _CriteriaBuilder = class _CriteriaBuilder extends Array {
  /**
...
__name(_CriteriaBuilder, "CriteriaBuilder");
var CriteriaBuilder = _CriteriaBuilder;
var TOKEN_IDENTIFIER = 1;
var TOKEN_OPERATOR = 2;
var TOKEN_VALUE = 3;
var TOKEN_PARAM = 4;
var ParseError = /* @__PURE__ */ __name(function(expression, error, position) {
...
function tokenize(expression) {
  ...
  __name(readArrayList, "readArrayList");
...
__name(shuntingYard, "shuntingYard");
...
__name(rpnTokensToCriteria, "rpnTokensToCriteria");
...
__name(internalParse, "internalParse");
...
__name(parseCriteria, "parseCriteria");
...
__name(Criteria, "Criteria");
Criteria.and = /* @__PURE__ */ __name(function and(c1, c2, ...rest) {
...
Criteria.isEmpty = /* @__PURE__ */ __name(function isEmpty(c) {
  return c == null || c.length === 0 || c.length === 1 && typeof c[0] === "string" && c[0].length === 0;
}, "isEmpty");
Criteria.join = /* @__PURE__ */ __name(function join(c1, op, c2) {
...
Criteria.not = /* @__PURE__ */ __name(function not(c) {
  return ["not", c];
}, "not");
Criteria.or = /* @__PURE__ */ __name(function or(c1, c2, ...rest) {
...
Criteria.paren = /* @__PURE__ */ __name(function parent(c) {
...
var _Uploader = class _Uploader {
  ...
  isMultiple() {
    var _a68, _b, _c;
    return !!((_c = this.opt.multiple) != null ? _c : (_b = (_a68 = this.opt) == null ? void 0 : _a68.input) == null ? void 0 : _b.multiple);
  }
  getTypePredicate() {
    var _a68, _b, _c;
  ...
  watchDropZone(node) {
    const stop = /* @__PURE__ */ __name((e) => e.preventDefault(), "stop");
  ...
  entriesApi(e, items) {
    return __async(this, null, function* () {
      ...
      const skipRest = /* @__PURE__ */ __name(() => {
        var _a68, _b;
        return !multiple && ((_b = (_a68 = this.batch) == null ? void 0 : _a68.filePaths) == null ? void 0 : _b.length) > 0;
      }, "skipRest");
      let readDirectory = /* @__PURE__ */ __name((entry, path) => __async(this, null, function* () {
        if (!path)
          path = entry.name;
      ...
      let readEntries = /* @__PURE__ */ __name((entry, reader, oldEntries, cb) => __async(this, null, function* () {
      ...
      try {
        yield new Promise((resolve, reject) => {
          ...
          try {
            ...
            const onerror = /* @__PURE__ */ __name((data) => {
              var _a70, _b3;
              data = Object.assign({
                batch,
                request,
...
__name(tryGetJson, "tryGetJson");

// src/base/validator.tsx
...
__name(validatorEventDelegate, "validatorEventDelegate");
...
var _Validator = class _Validator {
  constructor(form, options) {
    ...
    if (this.settings.onsubmit) {
      ...
      Fluent.on(this.currentForm, "submit.validator", (event) => {
        ...
        const stopSubmit = /* @__PURE__ */ __name(() => {
          event.preventDefault();
          event.stopPropagation();
          return false;
        }, "stopSubmit");
        const handle = /* @__PURE__ */ __name(() => {
          ...
          if (this.submitButton && (this.settings.submitHandler || this.formSubmitted)) {
            hidden = this.currentForm.appendChild(/* @__PURE__ */ jsx("input", { type: "hidden", name: this.submitButton.name, value: this.submitButton.value }));
          }
  ...
  static addClassRules(className2, rules) {
    if (typeof className2 === "string") {
      this.classRuleSettings[className2] = rules;
    } else {
      Object.assign(this.classRuleSettings, className2);
    }
  }
...
_Validator.defaults = {
  ...
  normalizer: /* @__PURE__ */ __name(function(value) {
    return typeof value === "string" ? value.trim() : value;
  }, "normalizer"),
  onfocusin: /* @__PURE__ */ __name(function(element, event, validator) {
    validator.lastActive = element;
  }, "onfocusin"),
  onfocusout: /* @__PURE__ */ __name(function(element, event, validator) {
    if (!_Validator.isCheckOrRadio(element) && (element.name in validator.submitted || !_Validator.optional(element))) {
      validator.element(element);
    }
  }, "onfocusout"),
  onkeyup: /* @__PURE__ */ __name(function(element, event, validator) {
    var excludedKeys = [
      "Shift",
      "Control",
      "Alt",
  ...
  onclick: /* @__PURE__ */ __name(function(element, event, validator) {
...
_Validator.methods = {
  required: /* @__PURE__ */ __name(function(value, element) {
    if (element instanceof HTMLSelectElement) {
      var val = _Validator.elementValue(element);
  ...
  customValidate: /* @__PURE__ */ __name(function(value, element) {
  ...
  dateQ: /* @__PURE__ */ __name(function(value, element) {
  ...
  dateTimeQ: /* @__PURE__ */ __name(function(value, element) {
    var o = _Validator.optional(element);
    if (o)
      return o;
    var d = parseDate(value);
  ...
  minlength: /* @__PURE__ */ __name(function(value, element, param) {
  ...
  maxlength: /* @__PURE__ */ __name(function(value, element, param) {
    var length = Array.isArray(value) ? value.length : _Validator.getLength(value, element);
    return _Validator.optional(element) || length <= param;
  }, "maxlength"),
  rangelength: /* @__PURE__ */ __name(function(value, element, param) {
    var length = Array.isArray(value) ? value.length : _Validator.getLength(value, element);
    return _Validator.optional(element) || length >= param[0] && length <= param[1];
  }, "rangelength"),
  min: /* @__PURE__ */ __name(function(value, element, param) {
    return _Validator.optional(element) || value >= param;
  }, "min"),
  max: /* @__PURE__ */ __name(function(value, element, param) {
    return _Validator.optional(element) || value <= param;
  }, "max"),
  range: /* @__PURE__ */ __name(function(value, element, param) {
    return _Validator.optional(element) || value >= param[0] && value <= param[1];
  }, "range"),
  url: /* @__PURE__ */ __name(function(value, element) {
...
__name(addValidationRule, "addValidationRule");
...
__name(removeValidationRule, "removeValidationRule");

// src/compat/arrays-compat.ts
...
__name(toGrouping, "toGrouping");
function tryFirst(array, predicate) {
  for (let x of array)
    if (predicate(x))
      return x;
}
__name(tryFirst, "tryFirst");

// src/compat/dialogs-compat.ts
...
__name(formatDayHourAndMin, "formatDayHourAndMin");
...
__name(parseHourAndMin, "parseHourAndMin");
...
__name(parseDayHourAndMin, "parseDayHourAndMin");

// src/compat/html-compat.ts
function addEmptyOption(select) {
  addOption(select, "", localText("Controls.SelectEditor.EmptyItemText"));
}
__name(addEmptyOption, "addEmptyOption");
...
__name(clearOptions, "clearOptions");
...
__name(findElementWithRelativeId, "findElementWithRelativeId");
function newBodyDiv() {
  var element = document.createElement("div");
  document.body.append(element);
  return element;
}
__name(newBodyDiv, "newBodyDiv");
function outerHtml(element) {
  var el = document.createElement("i");
  el.append((isArrayLike(element) ? element[0] : element).cloneNode(true));
  return el.innerHTML;
}
__name(outerHtml, "outerHtml");

// src/compat/layouttimer.ts
var LayoutTimer;
((LayoutTimer2) => {
  var timeout;
  var nextKey = 0;
  ...
  __name(onSizeChange, "onSizeChange");
  ...
  __name(onWidthChange, "onWidthChange");
...
__name(executeOnceWhenVisible, "executeOnceWhenVisible");
...
__name(executeEverytimeWhenVisible, "executeEverytimeWhenVisible");
...
((Router2) => {
  ...
  __name(isIgnoredDialog, "isIgnoredDialog");
  ...
  __name(isVisibleOrHiddenBy, "isVisibleOrHiddenBy");
  ...
  __name(getVisibleOrHiddenByDialogs, "getVisibleOrHiddenByDialogs");
  ...
  __name(onDialogOpen, "onDialogOpen");
  ...
  function resolve(newHash) {
    ...
    try {
      ...
      __name(closeMessages, "closeMessages");
      var dialogs = getVisibleOrHiddenByDialogs();
  ...
  __name(ignoreHashChange, "ignoreHashChange");
  ...
  if (typeof document !== "undefined") {
    ...
    __name(onDocumentDialogOpen, "onDocumentDialogOpen");
    __name(shouldTryBack, "shouldTryBack");
...
__name(addTypeMember, "addTypeMember");
function getTypes(from) {
  ...
  if (!from) {
    ...
    var traverse = /* @__PURE__ */ __name(function(s, n) {
      for (var c in s) {
...
__name(initializeTypes, "initializeTypes");
var _Exception = class _Exception extends Error {
  constructor(message) {
    super(message);
    this.name = "Exception";
  }
...
var _ArgumentNullException = class _ArgumentNullException extends Exception {
  constructor(paramName, message) {
    super((message || "Value cannot be null.") + "\nParameter name: " + paramName);
    this.name = "ArgumentNullException";
  }
};
__name(_ArgumentNullException, "ArgumentNullException");
var ArgumentNullException = _ArgumentNullException;
var _InvalidCastException = class _InvalidCastException extends Exception {
  constructor(message) {
    super(message);
    this.name = "InvalidCastException";
  }
};
__name(_InvalidCastException, "InvalidCastException");
var InvalidCastException = _InvalidCastException;
...
function initFullHeightGridPage(gridDiv, opt) {
  ...
  let layout = /* @__PURE__ */ __name(function() {
...
__name(initFullHeightGridPage, "initFullHeightGridPage");
...
__name(layoutFillHeightValue, "layoutFillHeightValue");
...
__name(layoutFillHeight, "layoutFillHeight");
...
__name(isMobileView, "isMobileView");
function initOnLoad() {
...
__name(triggerLayoutOnShow, "triggerLayoutOnShow");
...
__name(centerDialog, "centerDialog");

// src/compat/localtext-compat.ts
var text = localText;
...
__name(prefixedText, "prefixedText");
function dbTryText(prefix) {
  return function(key) {
    return localText("Db." + prefix + "." + key);
  };
}
__name(dbTryText, "dbTryText");
var LT;
((LT2) => {
...
((ScriptData2) => {
  ...
  __name(bindToChange, "bindToChange");
  function reload(name, dynJS) {
    getScriptDataHash(name, true);
    setScriptData(name, null);
    return (0, ScriptData2.ensure)(name, dynJS);
  }
...
__name(getColumnsAsync, "getColumnsAsync");
function getColumnsData(key) {
  return ScriptData.ensure("Columns." + key);
}
__name(getColumnsData, "getColumnsData");
...
__name(getFormAsync, "getFormAsync");
...
var serenity2 = global4.Serenity || (global4.Serenity = /* @__PURE__ */ Object.create(null));
for (i in compatExports)
  if (serenity2[i] == null)
    serenity2[i] = compatExports[i];
var i;

// src/compat/services-compat.tsx
...
__name(setEquality, "setEquality");
function postToCommon(url, form, target) {
  if (isSameOrigin(resolveUrl(url))) {
    var csrfToken = getCookie("CSRF-TOKEN");
    if (csrfToken) {
      form.appendChild(/* @__PURE__ */ jsx("input", { type: "hidden", name: "__RequestVerificationToken", value: csrfToken }));
    }
  }
  form.method = "POST";
  form.action = url;
  form.appendChild(/* @__PURE__ */ jsx("input", { type: "submit" }));
...
__name(postToCommon, "postToCommon");
function postToService(options) {
  postToCommon(options.url ? resolveUrl(options.url) : resolveServiceUrl(options.service), /* @__PURE__ */ jsx("form", { children: /* @__PURE__ */ jsx("input", { type: "hidden", name: "request", value: JSON.stringify(options.request) }) }), options.target);
}
__name(postToService, "postToService");
function postToUrl(options) {
  postToCommon(resolveUrl(options.url), /* @__PURE__ */ jsx("form", { children: options.params && Object.keys(options.params).map(
    (k) => /* @__PURE__ */ jsx("input", { type: "hidden", name: k, value: options.params[k] })
  ) }), options.target);
}
__name(postToUrl, "postToUrl");

// src/compat/strings-compat.ts
...
__name(isEmptyOrNull, "isEmptyOrNull");
function isTrimmedEmpty(s) {
  return !(s == null ? void 0 : s.trim());
}
__name(isTrimmedEmpty, "isTrimmedEmpty");
...
__name(toSingleLine, "toSingleLine");
var trimEnd = /* @__PURE__ */ __name(function(s) {
  var _a68, _b, _c;
  return (_c = (_b = (_a68 = s != null ? s : "").trimEnd) == null ? void 0 : _b.call(_a68)) != null ? _c : s.replace(/\s*$/, "");
}, "trimEnd");
var trimStart = /* @__PURE__ */ __name(function(s) {
  var _a68, _b, _c;
...
__name(trimToEmpty, "trimToEmpty");
...
__name(validatorAbortHandler, "validatorAbortHandler");
function validateOptions(options) {
  let opt = {};
  return extend(extend(opt, {
    errorPlacement: /* @__PURE__ */ __name(function(place, elem) {
      var _a68;
    ...
    submitHandler: /* @__PURE__ */ __name(function() {
      return false;
    }, "submitHandler"),
    invalidHandler: /* @__PURE__ */ __name(function(event, validator) {
      var _a68, _b, _c, _d, _e;
    ...
    success: /* @__PURE__ */ __name(function(label) {
...
((ValidationHelper2) => {
  ...
  __name(asyncSubmit, "asyncSubmit");
  ...
  __name(validateElement, "validateElement");
...
((Aggregators2) => {
  ...
  __name(WeightedAvg, "WeightedAvg");
  function Min(field) {
    this.field_ = field;
    this.type_ = "Min";
    this.init = function() {
...
((AggregateFormatting2) => {
  ...
  __name(formatMarkup, "formatMarkup");
  ...
  __name(groupTotalsFormatter, "groupTotalsFormatter");
...
var _RemoteView = class _RemoteView {
  constructor(options) {
    var _a68;
    var self2 = this;
    ...
    var groupingInfoDefaults = {
      getter: null,
      formatter: null,
      comparer: /* @__PURE__ */ __name(function(a, b) {
    ...
    __name(beginUpdate, "beginUpdate");
    function endUpdate() {
      suspend--;
      if (suspend <= 0)
        refresh();
    }
    __name(endUpdate, "endUpdate");
    function setRefreshHints(hints) {
      refreshHints = hints;
    }
    __name(setRefreshHints, "setRefreshHints");
    function setFilterArgs(args) {
      filterArgs = args;
    }
    __name(setFilterArgs, "setFilterArgs");
    ...
    __name(updateIdxById, "updateIdxById");
    ...
    __name(ensureIdUniqueness, "ensureIdUniqueness");
    function getItems() {
      return items;
    }
    ...
    __name(getIdPropertyName, "getIdPropertyName");
    ...
    __name(setPagingOptions, "setPagingOptions");
    ...
    __name(getPagingInfo, "getPagingInfo");
    ...
    __name(getSortComparer, "getSortComparer");
    ...
    __name(getLocalSort, "getLocalSort");
    ...
    __name(setLocalSort, "setLocalSort");
    ...
    __name(reSort, "reSort");
    function getFilteredItems() {
      return filteredItems;
    }
    __name(getFilteredItems, "getFilteredItems");
    function getFilter() {
      return filter;
    }
    ...
    __name(getGrouping, "getGrouping");
    ...
    __name(setSummaryOptions, "setSummaryOptions");
    ...
    __name(getGrandTotals, "getGrandTotals");
    ...
    __name(getItemByIdx, "getItemByIdx");
    function getIdxById(id) {
      return idxById[id];
    }
    __name(getIdxById, "getIdxById");
    ...
    __name(ensureRowsByIdCache, "ensureRowsByIdCache");
    function getRowByItem(item) {
      ensureRowsByIdCache();
      return rowsById[item[idProperty]];
    }
    __name(getRowByItem, "getRowByItem");
    function getRowById(id) {
      ensureRowsByIdCache();
      return rowsById[id];
    }
    __name(getRowById, "getRowById");
    ...
    __name(mapItemsToRows, "mapItemsToRows");
    ...
    __name(mapIdsToRows, "mapIdsToRows");
    ...
    __name(mapRowsToIds, "mapRowsToIds");
    ...
    __name(sortedAddItem, "sortedAddItem");
    ...
    __name(sortedUpdateItem, "sortedUpdateItem");
    ...
    __name(getItemMetadata, "getItemMetadata");
    ...
    __name(expandCollapseAllGroups, "expandCollapseAllGroups");
    ...
    __name(resolveLevelAndGroupingKey, "resolveLevelAndGroupingKey");
    ...
    __name(expandCollapseGroup, "expandCollapseGroup");
    function collapseGroup(varArgs) {
      var args = Array.prototype.slice.call(arguments);
      expandCollapseGroup(args, true);
    }
    __name(collapseGroup, "collapseGroup");
    function expandGroup(varArgs) {
      var args = Array.prototype.slice.call(arguments);
      expandCollapseGroup(args, false);
    }
    __name(expandGroup, "expandGroup");
    function getGroups() {
      return groups;
    }
    ...
    __name(extractGroups, "extractGroups");
    ...
    __name(addGroupTotals, "addGroupTotals");
    ...
    __name(flattenGroupedRows, "flattenGroupedRows");
    ...
    __name(getFunctionInfo, "getFunctionInfo");
    ...
    __name(compileAccumulatorLoop, "compileAccumulatorLoop");
    ...
    __name(compileFilter, "compileFilter");
    ...
    __name(compileFilterWithCaching, "compileFilterWithCaching");
    ...
    __name(uncompiledFilter, "uncompiledFilter");
    ...
    __name(uncompiledFilterWithCaching, "uncompiledFilterWithCaching");
    ...
    __name(getFilteredAndPagedItems, "getFilteredAndPagedItems");
    ...
    __name(getRowDiffs, "getRowDiffs");
    ...
    function syncGridSelection(grid, preserveHidden, preserveHiddenOnSelectionChange) {
      ...
      __name(setSelectedRowIds, "setSelectedRowIds");
      function update() {
    ...
    __name(syncGridSelection, "syncGridSelection");
    function syncGridCellCssStyles(grid, key) {
      ...
      __name(storeCellCssStyles, "storeCellCssStyles");
      function update() {
        if (hashById) {
          inHandler = true;
          ensureRowsByIdCache();
      ...
      __name(update, "update");
      var subFunc = /* @__PURE__ */ __name(function(e, args) {
        if (inHandler) {
          return;
        }
        if (key != args.key) {
    ...
    __name(syncGridCellCssStyles, "syncGridCellCssStyles");
    ...
    function populate() {
      ...
      var serviceOptions = {
        ...
        onSuccess: /* @__PURE__ */ __name(function(response) {
          addData(response);
        }, "onSuccess"),
        onCleanup: /* @__PURE__ */ __name(function() {
          loading = false;
          onPagingInfoChanged.notify(getPagingInfo());
    ...
    __name(populateLock, "populateLock");
    ...
    __name(populateUnlock, "populateUnlock");
    function getGroupItemMetadataProvider() {
      return groupItemMetadataProvider;
    }
    __name(getGroupItemMetadataProvider, "getGroupItemMetadataProvider");
    function setGroupItemMetadataProvider(value) {
      groupItemMetadataProvider = value;
    }
    __name(setGroupItemMetadataProvider, "setGroupItemMetadataProvider");
...
__name(_RemoteView, "RemoteView");
var RemoteView = _RemoteView;
...
_EnumKeyAttribute_decorators = [attr2("EnumKey")];
var _EnumKeyAttribute = class _EnumKeyAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init = __decoratorStart(null);
_EnumKeyAttribute = __decorateElement(_init, 0, "EnumKeyAttribute", _EnumKeyAttribute_decorators, _EnumKeyAttribute);
__name(_EnumKeyAttribute, "EnumKeyAttribute");
__runInitializers(_init, 1, _EnumKeyAttribute);
var EnumKeyAttribute = _EnumKeyAttribute;
var _DisplayNameAttribute_decorators, _init2;
_DisplayNameAttribute_decorators = [attr2("DisplayName")];
var _DisplayNameAttribute = class _DisplayNameAttribute {
  constructor(displayName) {
    this.displayName = displayName;
  }
};
_init2 = __decoratorStart(null);
_DisplayNameAttribute = __decorateElement(_init2, 0, "DisplayNameAttribute", _DisplayNameAttribute_decorators, _DisplayNameAttribute);
__name(_DisplayNameAttribute, "DisplayNameAttribute");
__runInitializers(_init2, 1, _DisplayNameAttribute);
var DisplayNameAttribute = _DisplayNameAttribute;
var _CategoryAttribute_decorators, _init3;
_CategoryAttribute_decorators = [attr2("Category")];
var _CategoryAttribute = class _CategoryAttribute {
  constructor(category) {
    this.category = category;
  }
};
_init3 = __decoratorStart(null);
_CategoryAttribute = __decorateElement(_init3, 0, "CategoryAttribute", _CategoryAttribute_decorators, _CategoryAttribute);
__name(_CategoryAttribute, "CategoryAttribute");
__runInitializers(_init3, 1, _CategoryAttribute);
var CategoryAttribute = _CategoryAttribute;
var _ColumnsKeyAttribute_decorators, _init4;
_ColumnsKeyAttribute_decorators = [attr2("ColumnsKey")];
var _ColumnsKeyAttribute = class _ColumnsKeyAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init4 = __decoratorStart(null);
_ColumnsKeyAttribute = __decorateElement(_init4, 0, "ColumnsKeyAttribute", _ColumnsKeyAttribute_decorators, _ColumnsKeyAttribute);
__name(_ColumnsKeyAttribute, "ColumnsKeyAttribute");
__runInitializers(_init4, 1, _ColumnsKeyAttribute);
var ColumnsKeyAttribute = _ColumnsKeyAttribute;
var _CloseButtonAttribute_decorators, _init5;
_CloseButtonAttribute_decorators = [attr2("CloseButton")];
var _CloseButtonAttribute = class _CloseButtonAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init5 = __decoratorStart(null);
_CloseButtonAttribute = __decorateElement(_init5, 0, "CloseButtonAttribute", _CloseButtonAttribute_decorators, _CloseButtonAttribute);
__name(_CloseButtonAttribute, "CloseButtonAttribute");
__runInitializers(_init5, 1, _CloseButtonAttribute);
var CloseButtonAttribute = _CloseButtonAttribute;
var _CssClassAttribute_decorators, _init6;
_CssClassAttribute_decorators = [attr2("CssClass")];
var _CssClassAttribute = class _CssClassAttribute {
  constructor(cssClass) {
    this.cssClass = cssClass;
  }
};
_init6 = __decoratorStart(null);
_CssClassAttribute = __decorateElement(_init6, 0, "CssClassAttribute", _CssClassAttribute_decorators, _CssClassAttribute);
__name(_CssClassAttribute, "CssClassAttribute");
__runInitializers(_init6, 1, _CssClassAttribute);
var CssClassAttribute = _CssClassAttribute;
var _DefaultValueAttribute_decorators, _init7;
_DefaultValueAttribute_decorators = [attr2("DefaultValue")];
var _DefaultValueAttribute = class _DefaultValueAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init7 = __decoratorStart(null);
_DefaultValueAttribute = __decorateElement(_init7, 0, "DefaultValueAttribute", _DefaultValueAttribute_decorators, _DefaultValueAttribute);
__name(_DefaultValueAttribute, "DefaultValueAttribute");
__runInitializers(_init7, 1, _DefaultValueAttribute);
var DefaultValueAttribute = _DefaultValueAttribute;
var _DialogTypeAttribute_decorators, _init8;
_DialogTypeAttribute_decorators = [attr2("DialogType")];
var _DialogTypeAttribute = class _DialogTypeAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init8 = __decoratorStart(null);
_DialogTypeAttribute = __decorateElement(_init8, 0, "DialogTypeAttribute", _DialogTypeAttribute_decorators, _DialogTypeAttribute);
__name(_DialogTypeAttribute, "DialogTypeAttribute");
__runInitializers(_init8, 1, _DialogTypeAttribute);
var DialogTypeAttribute = _DialogTypeAttribute;
var _EditorOptionAttribute_decorators, _init9;
_EditorOptionAttribute_decorators = [attr2("EditorOption")];
var _EditorOptionAttribute = class _EditorOptionAttribute {
...
_EditorOptionAttribute = __decorateElement(_init9, 0, "EditorOptionAttribute", _EditorOptionAttribute_decorators, _EditorOptionAttribute);
__name(_EditorOptionAttribute, "EditorOptionAttribute");
__runInitializers(_init9, 1, _EditorOptionAttribute);
var EditorOptionAttribute = _EditorOptionAttribute;
var _EditorTypeAttributeBase = class _EditorTypeAttributeBase {
...
__name(_EditorTypeAttributeBase, "EditorTypeAttributeBase");
var EditorTypeAttributeBase = _EditorTypeAttributeBase;
registerClass(EditorTypeAttributeBase, "Serenity.EditorTypeAttributeBase");
var _EditorTypeAttribute_decorators, _init10, _a2;
_EditorTypeAttribute_decorators = [attr2("EditorType")];
var _EditorTypeAttribute = class _EditorTypeAttribute extends (_a2 = EditorTypeAttributeBase) {
  constructor(editorType) {
    super(editorType);
  }
};
_init10 = __decoratorStart(_a2);
_EditorTypeAttribute = __decorateElement(_init10, 0, "EditorTypeAttribute", _EditorTypeAttribute_decorators, _EditorTypeAttribute);
__name(_EditorTypeAttribute, "EditorTypeAttribute");
__runInitializers(_init10, 1, _EditorTypeAttribute);
var EditorTypeAttribute = _EditorTypeAttribute;
var _ElementAttribute_decorators, _init11;
_ElementAttribute_decorators = [attr2("Element")];
var _ElementAttribute = class _ElementAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init11 = __decoratorStart(null);
_ElementAttribute = __decorateElement(_init11, 0, "ElementAttribute", _ElementAttribute_decorators, _ElementAttribute);
__name(_ElementAttribute, "ElementAttribute");
__runInitializers(_init11, 1, _ElementAttribute);
var ElementAttribute = _ElementAttribute;
var _EntityTypeAttribute_decorators, _init12;
_EntityTypeAttribute_decorators = [attr2("EntityType")];
var _EntityTypeAttribute = class _EntityTypeAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init12 = __decoratorStart(null);
_EntityTypeAttribute = __decorateElement(_init12, 0, "EntityTypeAttribute", _EntityTypeAttribute_decorators, _EntityTypeAttribute);
__name(_EntityTypeAttribute, "EntityTypeAttribute");
__runInitializers(_init12, 1, _EntityTypeAttribute);
var EntityTypeAttribute = _EntityTypeAttribute;
var _FilterableAttribute_decorators, _init13;
_FilterableAttribute_decorators = [attr2("Filterable")];
var _FilterableAttribute = class _FilterableAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init13 = __decoratorStart(null);
_FilterableAttribute = __decorateElement(_init13, 0, "FilterableAttribute", _FilterableAttribute_decorators, _FilterableAttribute);
__name(_FilterableAttribute, "FilterableAttribute");
__runInitializers(_init13, 1, _FilterableAttribute);
var FilterableAttribute = _FilterableAttribute;
var _FlexifyAttribute_decorators, _init14;
_FlexifyAttribute_decorators = [attr2("Flexify")];
var _FlexifyAttribute = class _FlexifyAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init14 = __decoratorStart(null);
_FlexifyAttribute = __decorateElement(_init14, 0, "FlexifyAttribute", _FlexifyAttribute_decorators, _FlexifyAttribute);
__name(_FlexifyAttribute, "FlexifyAttribute");
__runInitializers(_init14, 1, _FlexifyAttribute);
var FlexifyAttribute = _FlexifyAttribute;
var _FormKeyAttribute_decorators, _init15;
_FormKeyAttribute_decorators = [attr2("FormKey")];
var _FormKeyAttribute = class _FormKeyAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init15 = __decoratorStart(null);
_FormKeyAttribute = __decorateElement(_init15, 0, "FormKeyAttribute", _FormKeyAttribute_decorators, _FormKeyAttribute);
__name(_FormKeyAttribute, "FormKeyAttribute");
__runInitializers(_init15, 1, _FormKeyAttribute);
var FormKeyAttribute = _FormKeyAttribute;
var _GeneratedCodeAttribute_decorators, _init16;
_GeneratedCodeAttribute_decorators = [attr2("GeneratedCode")];
var _GeneratedCodeAttribute = class _GeneratedCodeAttribute {
  constructor(origin) {
    this.origin = origin;
  }
};
_init16 = __decoratorStart(null);
_GeneratedCodeAttribute = __decorateElement(_init16, 0, "GeneratedCodeAttribute", _GeneratedCodeAttribute_decorators, _GeneratedCodeAttribute);
__name(_GeneratedCodeAttribute, "GeneratedCodeAttribute");
__runInitializers(_init16, 1, _GeneratedCodeAttribute);
var GeneratedCodeAttribute = _GeneratedCodeAttribute;
var _HiddenAttribute_decorators, _init17;
_HiddenAttribute_decorators = [attr2("Hidden")];
var _HiddenAttribute = class _HiddenAttribute {
  constructor() {
  }
};
_init17 = __decoratorStart(null);
_HiddenAttribute = __decorateElement(_init17, 0, "HiddenAttribute", _HiddenAttribute_decorators, _HiddenAttribute);
__name(_HiddenAttribute, "HiddenAttribute");
__runInitializers(_init17, 1, _HiddenAttribute);
var HiddenAttribute = _HiddenAttribute;
var _HintAttribute_decorators, _init18;
_HintAttribute_decorators = [attr2("Hint")];
var _HintAttribute = class _HintAttribute {
  constructor(hint) {
    this.hint = hint;
  }
};
_init18 = __decoratorStart(null);
_HintAttribute = __decorateElement(_init18, 0, "HintAttribute", _HintAttribute_decorators, _HintAttribute);
__name(_HintAttribute, "HintAttribute");
__runInitializers(_init18, 1, _HintAttribute);
var HintAttribute = _HintAttribute;
var _IdPropertyAttribute_decorators, _init19;
_IdPropertyAttribute_decorators = [attr2("IdProperty")];
var _IdPropertyAttribute = class _IdPropertyAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init19 = __decoratorStart(null);
_IdPropertyAttribute = __decorateElement(_init19, 0, "IdPropertyAttribute", _IdPropertyAttribute_decorators, _IdPropertyAttribute);
__name(_IdPropertyAttribute, "IdPropertyAttribute");
__runInitializers(_init19, 1, _IdPropertyAttribute);
var IdPropertyAttribute = _IdPropertyAttribute;
var _InsertableAttribute_decorators, _init20;
_InsertableAttribute_decorators = [attr2("Insertable")];
var _InsertableAttribute = class _InsertableAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init20 = __decoratorStart(null);
_InsertableAttribute = __decorateElement(_init20, 0, "InsertableAttribute", _InsertableAttribute_decorators, _InsertableAttribute);
__name(_InsertableAttribute, "InsertableAttribute");
__runInitializers(_init20, 1, _InsertableAttribute);
var InsertableAttribute = _InsertableAttribute;
var _IsActivePropertyAttribute_decorators, _init21;
_IsActivePropertyAttribute_decorators = [attr2("IsActiveProperty")];
var _IsActivePropertyAttribute = class _IsActivePropertyAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init21 = __decoratorStart(null);
_IsActivePropertyAttribute = __decorateElement(_init21, 0, "IsActivePropertyAttribute", _IsActivePropertyAttribute_decorators, _IsActivePropertyAttribute);
__name(_IsActivePropertyAttribute, "IsActivePropertyAttribute");
__runInitializers(_init21, 1, _IsActivePropertyAttribute);
var IsActivePropertyAttribute = _IsActivePropertyAttribute;
var _ItemNameAttribute_decorators, _init22;
_ItemNameAttribute_decorators = [attr2("ItemName")];
var _ItemNameAttribute = class _ItemNameAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init22 = __decoratorStart(null);
_ItemNameAttribute = __decorateElement(_init22, 0, "ItemNameAttribute", _ItemNameAttribute_decorators, _ItemNameAttribute);
__name(_ItemNameAttribute, "ItemNameAttribute");
__runInitializers(_init22, 1, _ItemNameAttribute);
var ItemNameAttribute = _ItemNameAttribute;
var _LocalTextPrefixAttribute_decorators, _init23;
_LocalTextPrefixAttribute_decorators = [attr2("LocalTextPrefix")];
var _LocalTextPrefixAttribute = class _LocalTextPrefixAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init23 = __decoratorStart(null);
_LocalTextPrefixAttribute = __decorateElement(_init23, 0, "LocalTextPrefixAttribute", _LocalTextPrefixAttribute_decorators, _LocalTextPrefixAttribute);
__name(_LocalTextPrefixAttribute, "LocalTextPrefixAttribute");
__runInitializers(_init23, 1, _LocalTextPrefixAttribute);
var LocalTextPrefixAttribute = _LocalTextPrefixAttribute;
var _MaximizableAttribute_decorators, _init24;
_MaximizableAttribute_decorators = [attr2("Maximizable")];
var _MaximizableAttribute = class _MaximizableAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init24 = __decoratorStart(null);
_MaximizableAttribute = __decorateElement(_init24, 0, "MaximizableAttribute", _MaximizableAttribute_decorators, _MaximizableAttribute);
__name(_MaximizableAttribute, "MaximizableAttribute");
__runInitializers(_init24, 1, _MaximizableAttribute);
var MaximizableAttribute = _MaximizableAttribute;
var _MaxLengthAttribute_decorators, _init25;
_MaxLengthAttribute_decorators = [attr2("MaxLength")];
var _MaxLengthAttribute = class _MaxLengthAttribute {
  constructor(maxLength) {
    this.maxLength = maxLength;
  }
};
_init25 = __decoratorStart(null);
_MaxLengthAttribute = __decorateElement(_init25, 0, "MaxLengthAttribute", _MaxLengthAttribute_decorators, _MaxLengthAttribute);
__name(_MaxLengthAttribute, "MaxLengthAttribute");
__runInitializers(_init25, 1, _MaxLengthAttribute);
var MaxLengthAttribute = _MaxLengthAttribute;
var _NamePropertyAttribute_decorators, _init26;
_NamePropertyAttribute_decorators = [attr2("NameProperty")];
var _NamePropertyAttribute = class _NamePropertyAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init26 = __decoratorStart(null);
_NamePropertyAttribute = __decorateElement(_init26, 0, "NamePropertyAttribute", _NamePropertyAttribute_decorators, _NamePropertyAttribute);
__name(_NamePropertyAttribute, "NamePropertyAttribute");
__runInitializers(_init26, 1, _NamePropertyAttribute);
var NamePropertyAttribute = _NamePropertyAttribute;
var _OneWayAttribute_decorators, _init27;
_OneWayAttribute_decorators = [attr2("OneWay")];
var _OneWayAttribute = class _OneWayAttribute {
};
_init27 = __decoratorStart(null);
_OneWayAttribute = __decorateElement(_init27, 0, "OneWayAttribute", _OneWayAttribute_decorators, _OneWayAttribute);
__name(_OneWayAttribute, "OneWayAttribute");
__runInitializers(_init27, 1, _OneWayAttribute);
var OneWayAttribute = _OneWayAttribute;
var _OptionAttribute_decorators, _init28;
_OptionAttribute_decorators = [attr2("Option")];
var _OptionAttribute = class _OptionAttribute {
};
_init28 = __decoratorStart(null);
_OptionAttribute = __decorateElement(_init28, 0, "OptionAttribute", _OptionAttribute_decorators, _OptionAttribute);
__name(_OptionAttribute, "OptionAttribute");
__runInitializers(_init28, 1, _OptionAttribute);
var OptionAttribute = _OptionAttribute;
var _OptionsTypeAttribute_decorators, _init29;
_OptionsTypeAttribute_decorators = [attr2("OptionsType")];
var _OptionsTypeAttribute = class _OptionsTypeAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init29 = __decoratorStart(null);
_OptionsTypeAttribute = __decorateElement(_init29, 0, "OptionsTypeAttribute", _OptionsTypeAttribute_decorators, _OptionsTypeAttribute);
__name(_OptionsTypeAttribute, "OptionsTypeAttribute");
__runInitializers(_init29, 1, _OptionsTypeAttribute);
var OptionsTypeAttribute = _OptionsTypeAttribute;
var _PanelAttribute_decorators, _init30;
_PanelAttribute_decorators = [attr2("Panel")];
var _PanelAttribute = class _PanelAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init30 = __decoratorStart(null);
_PanelAttribute = __decorateElement(_init30, 0, "PanelAttribute", _PanelAttribute_decorators, _PanelAttribute);
__name(_PanelAttribute, "PanelAttribute");
__runInitializers(_init30, 1, _PanelAttribute);
var PanelAttribute = _PanelAttribute;
var _PlaceholderAttribute_decorators, _init31;
_PlaceholderAttribute_decorators = [attr2("Placeholder")];
var _PlaceholderAttribute = class _PlaceholderAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init31 = __decoratorStart(null);
_PlaceholderAttribute = __decorateElement(_init31, 0, "PlaceholderAttribute", _PlaceholderAttribute_decorators, _PlaceholderAttribute);
__name(_PlaceholderAttribute, "PlaceholderAttribute");
__runInitializers(_init31, 1, _PlaceholderAttribute);
var PlaceholderAttribute = _PlaceholderAttribute;
var _ReadOnlyAttribute_decorators, _init32;
_ReadOnlyAttribute_decorators = [attr2("ReadOnly")];
var _ReadOnlyAttribute = class _ReadOnlyAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init32 = __decoratorStart(null);
_ReadOnlyAttribute = __decorateElement(_init32, 0, "ReadOnlyAttribute", _ReadOnlyAttribute_decorators, _ReadOnlyAttribute);
__name(_ReadOnlyAttribute, "ReadOnlyAttribute");
__runInitializers(_init32, 1, _ReadOnlyAttribute);
var ReadOnlyAttribute = _ReadOnlyAttribute;
var _RequiredAttribute_decorators, _init33;
_RequiredAttribute_decorators = [attr2("Required")];
var _RequiredAttribute = class _RequiredAttribute {
  constructor(isRequired = true) {
    this.isRequired = isRequired;
  }
};
_init33 = __decoratorStart(null);
_RequiredAttribute = __decorateElement(_init33, 0, "RequiredAttribute", _RequiredAttribute_decorators, _RequiredAttribute);
__name(_RequiredAttribute, "RequiredAttribute");
__runInitializers(_init33, 1, _RequiredAttribute);
var RequiredAttribute = _RequiredAttribute;
var _ResizableAttribute_decorators, _init34;
_ResizableAttribute_decorators = [attr2("Resizable")];
var _ResizableAttribute = class _ResizableAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init34 = __decoratorStart(null);
_ResizableAttribute = __decorateElement(_init34, 0, "ResizableAttribute", _ResizableAttribute_decorators, _ResizableAttribute);
__name(_ResizableAttribute, "ResizableAttribute");
__runInitializers(_init34, 1, _ResizableAttribute);
var ResizableAttribute = _ResizableAttribute;
var _ResponsiveAttribute_decorators, _init35;
_ResponsiveAttribute_decorators = [attr2("Responsive")];
var _ResponsiveAttribute = class _ResponsiveAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init35 = __decoratorStart(null);
_ResponsiveAttribute = __decorateElement(_init35, 0, "ResponsiveAttribute", _ResponsiveAttribute_decorators, _ResponsiveAttribute);
__name(_ResponsiveAttribute, "ResponsiveAttribute");
__runInitializers(_init35, 1, _ResponsiveAttribute);
var ResponsiveAttribute = _ResponsiveAttribute;
var _ServiceAttribute_decorators, _init36;
_ServiceAttribute_decorators = [attr2("Service")];
var _ServiceAttribute = class _ServiceAttribute {
  constructor(value) {
    this.value = value;
  }
};
_init36 = __decoratorStart(null);
_ServiceAttribute = __decorateElement(_init36, 0, "ServiceAttribute", _ServiceAttribute_decorators, _ServiceAttribute);
__name(_ServiceAttribute, "ServiceAttribute");
__runInitializers(_init36, 1, _ServiceAttribute);
var ServiceAttribute = _ServiceAttribute;
var _StaticPanelAttribute_decorators, _init37;
_StaticPanelAttribute_decorators = [attr2("StaticPanel")];
var _StaticPanelAttribute = class _StaticPanelAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init37 = __decoratorStart(null);
_StaticPanelAttribute = __decorateElement(_init37, 0, "StaticPanelAttribute", _StaticPanelAttribute_decorators, _StaticPanelAttribute);
__name(_StaticPanelAttribute, "StaticPanelAttribute");
__runInitializers(_init37, 1, _StaticPanelAttribute);
var StaticPanelAttribute = _StaticPanelAttribute;
var _UpdatableAttribute_decorators, _init38;
_UpdatableAttribute_decorators = [attr2("Updatable")];
var _UpdatableAttribute = class _UpdatableAttribute {
  constructor(value = true) {
    this.value = value;
  }
};
_init38 = __decoratorStart(null);
_UpdatableAttribute = __decorateElement(_init38, 0, "UpdatableAttribute", _UpdatableAttribute_decorators, _UpdatableAttribute);
__name(_UpdatableAttribute, "UpdatableAttribute");
__runInitializers(_init38, 1, _UpdatableAttribute);
var UpdatableAttribute = _UpdatableAttribute;
...
((Decorators2) => {
  ...
  __name(registerType2, "registerType");
  ...
  __name(registerClass2, "registerClass");
  ...
  __name(registerInterface2, "registerInterface");
  ...
  __name(registerEditor2, "registerEditor");
  ...
  __name(registerEnum2, "registerEnum");
  ...
  __name(registerEnumType, "registerEnumType");
  ...
  __name(registerFormatter2, "registerFormatter");
  ...
  __name(dialogType, "dialogType");
  function editor() {
    return function(target, _context) {
      var attr3 = new EditorAttribute();
      addCustomAttribute(target, attr3);
    };
  }
  ...
  __name(maximizable, "maximizable");
  ...
  __name(optionsType, "optionsType");
  ...
  __name(staticPanel, "staticPanel");
...
var _IBooleanValue = class _IBooleanValue {
};
_init39 = __decoratorStart(null);
_IBooleanValue = __decorateElement(_init39, 0, "IBooleanValue", _IBooleanValue_decorators, _IBooleanValue);
__name(_IBooleanValue, "IBooleanValue");
__runInitializers(_init39, 1, _IBooleanValue);
var IBooleanValue = _IBooleanValue;
...
var _IDoubleValue = class _IDoubleValue {
};
_init40 = __decoratorStart(null);
_IDoubleValue = __decorateElement(_init40, 0, "IDoubleValue", _IDoubleValue_decorators, _IDoubleValue);
__name(_IDoubleValue, "IDoubleValue");
__runInitializers(_init40, 1, _IDoubleValue);
var IDoubleValue = _IDoubleValue;
...
var _IDialog = class _IDialog {
};
_init41 = __decoratorStart(null);
_IDialog = __decorateElement(_init41, 0, "IDialog", _IDialog_decorators, _IDialog);
__name(_IDialog, "IDialog");
__runInitializers(_init41, 1, _IDialog);
var IDialog = _IDialog;
...
var _IEditDialog = class _IEditDialog {
};
_init42 = __decoratorStart(null);
_IEditDialog = __decorateElement(_init42, 0, "IEditDialog", _IEditDialog_decorators, _IEditDialog);
__name(_IEditDialog, "IEditDialog");
__runInitializers(_init42, 1, _IEditDialog);
var IEditDialog = _IEditDialog;
...
var _IGetEditValue = class _IGetEditValue {
};
_init43 = __decoratorStart(null);
_IGetEditValue = __decorateElement(_init43, 0, "IGetEditValue", _IGetEditValue_decorators, _IGetEditValue);
__name(_IGetEditValue, "IGetEditValue");
__runInitializers(_init43, 1, _IGetEditValue);
var IGetEditValue = _IGetEditValue;
...
var _IReadOnly = class _IReadOnly {
};
_init44 = __decoratorStart(null);
_IReadOnly = __decorateElement(_init44, 0, "IReadOnly", _IReadOnly_decorators, _IReadOnly);
__name(_IReadOnly, "IReadOnly");
__runInitializers(_init44, 1, _IReadOnly);
var IReadOnly = _IReadOnly;
...
var _ISetEditValue = class _ISetEditValue {
};
_init45 = __decoratorStart(null);
_ISetEditValue = __decorateElement(_init45, 0, "ISetEditValue", _ISetEditValue_decorators, _ISetEditValue);
__name(_ISetEditValue, "ISetEditValue");
__runInitializers(_init45, 1, _ISetEditValue);
var ISetEditValue = _ISetEditValue;
...
var _IStringValue = class _IStringValue {
};
_init46 = __decoratorStart(null);
_IStringValue = __decorateElement(_init46, 0, "IStringValue", _IStringValue_decorators, _IStringValue);
__name(_IStringValue, "IStringValue");
__runInitializers(_init46, 1, _IStringValue);
var IStringValue = _IStringValue;
...
var _IValidateRequired = class _IValidateRequired {
};
_init47 = __decoratorStart(null);
_IValidateRequired = __decorateElement(_init47, 0, "IValidateRequired", _IValidateRequired_decorators, _IValidateRequired);
__name(_IValidateRequired, "IValidateRequired");
__runInitializers(_init47, 1, _IValidateRequired);
var IValidateRequired = _IValidateRequired;
...
function commonTypeRegistry(props) {
  ...
  __name(searchSystemTypes, "searchSystemTypes");
  function init() {
    knownTypes = {};
  ...
  function tryGetOrLoad(key) {
    ...
    if (key && Config.lazyTypeLoader) {
      ...
      if (!promise && suffix) {
        promise = Config.lazyTypeLoader(key + suffix, kind);
      }
      if (!promise) {
        for (var ns of Config.rootNamespaces) {
          const k = ns + "." + key;
          if (promise = Config.lazyTypeLoader(k, kind))
            break;
          if (suffix && (promise = Config.lazyTypeLoader(k + suffix, kind)))
            break;
        }
      }
  ...
  __name(tryGetOrLoad, "tryGetOrLoad");
  function get(key) {
    var type = tryGet(key);
    if (type)
      return type;
...
__name(commonTypeRegistry, "commonTypeRegistry");
...
((DialogTypeRegistry2) => {
  const registry = commonTypeRegistry({
    attrKey: null,
    isMatch: /* @__PURE__ */ __name((type) => isAssignableFrom(IDialog, type), "isMatch"),
    kind: "dialog",
    suffix: "Dialog",
    loadError: /* @__PURE__ */ __name(function(key) {
...
__name(getWidgetName, "getWidgetName");
...
__name(associateWidget, "associateWidget");
...
__name(deassociateWidget, "deassociateWidget");
function tryGetWidget(element, type) {
  ...
  if (!widgets)
    return null;
  var keys2 = Object.keys(widgets);
  if (!keys2.length)
    return null;
  if (!type)
    return (_a68 = widgets[keys2[0]]) != null ? _a68 : null;
...
__name(tryGetWidget, "tryGetWidget");
...
__name(getWidgetFrom, "getWidgetFrom");
...
__name(useIdPrefix, "useIdPrefix");
var idPrefixHandler = {
  get(target, p) {
    if (p.startsWith("#"))
...
function applyGetWidgetExtensions($2) {
  if (!$2 || !$2.fn)
    return false;
  $2.fn.tryGetWidget = /* @__PURE__ */ __name(function tryGetWidget$(type) {
    return tryGetWidget(this[0], type);
  }, "tryGetWidget$");
  $2.fn.getWidget = /* @__PURE__ */ __name(function getWidget$(type) {
...
__name(applyGetWidgetExtensions, "applyGetWidgetExtensions");
...
var KEY = {
  ...
  BACKSPACE: 8,
  DELETE: 46,
  isArrow: /* @__PURE__ */ __name(function(k) {
    k = k.which ? k.which : k;
    switch (k) {
      case KEY.LEFT:
      case KEY.RIGHT:
  ...
  isControl: /* @__PURE__ */ __name(function(e) {
    var k = e.which;
    switch (k) {
      case KEY.SHIFT:
      case KEY.CTRL:
  ...
  isFunctionKey: /* @__PURE__ */ __name(function(k) {
    k = k.which ? k.which : k;
    return k >= 112 && k <= 123;
  }, "isFunctionKey")
};
...
__name(reinsertElement, "reinsertElement");
...
__name(measureScrollbar, "measureScrollbar");
function equal(a, b) {
  if (a === b) return true;
...
function getSideBorderPadding(el) {
  ...
  var delta = 0;
  for (var val of p)
    delta += parsePx(style2.getPropertyValue(val)) || 0;
  return delta;
}
__name(getSideBorderPadding, "getSideBorderPadding");
function getOuterHeightWithMargins(el) {
  const style2 = getComputedStyle(el);
  return el.getBoundingClientRect().height + parseFloat(style2.marginTop) + parseFloat(style2.marginBottom);
}
__name(getOuterHeightWithMargins, "getOuterHeightWithMargins");
...
__name(installKeyUpChangeEvent, "installKeyUpChangeEvent");
...
__name(installFilteredMouseMove, "installFilteredMouseMove");
...
__name(installDebouncedScroll, "installDebouncedScroll");
function focus($el) {
...
__name(killEvent, "killEvent");
function killEventImmediately(event) {
  event.preventDefault();
  event.stopImmediatePropagation();
}
__name(killEventImmediately, "killEventImmediately");
var sizer;
function measureTextWidth(e) {
  if (!sizer) {
    var style2 = getComputedStyle(e, null);
...
__name(syncCssClasses, "syncCssClasses");
...
__name(defaultEscapeMarkup, "defaultEscapeMarkup");
...
_Select2.defaults = {
  ...
  containerCssClass: "",
  dropdownCssClass: "",
  formatAjaxError: /* @__PURE__ */ __name(() => txt("AjaxError"), "formatAjaxError"),
  formatInputTooLong: /* @__PURE__ */ __name((input, max) => fmt("InputTooLong", input.length - max, max, input.length), "formatInputTooLong"),
  formatInputTooShort: /* @__PURE__ */ __name((input, min) => fmt("InputTooShort", min - input.length, min, input.length), "formatInputTooShort"),
  formatLoadMore: /* @__PURE__ */ __name((pageNumber) => fmt("LoadMore", pageNumber), "formatLoadMore"),
  formatMatches: /* @__PURE__ */ __name((matches) => matches === 1 ? txt("SingleMatch") : fmt("MultipleMatches", matches), "formatMatches"),
  formatNoMatches: /* @__PURE__ */ __name(() => txt("NoMatches"), "formatNoMatches"),
  formatResult: /* @__PURE__ */ __name(function(result, _, query, escapeMarkup) {
    var markup = [];
    markMatch(result.text, query.term, markup, escapeMarkup);
    return markup.join("");
  }, "formatResult"),
  formatResultCssClass: /* @__PURE__ */ __name(function(data) {
    return data.css;
  }, "formatResultCssClass"),
  formatSearching: /* @__PURE__ */ __name(() => txt("Searching"), "formatSearching"),
  formatSelection: /* @__PURE__ */ __name((data, _, escapeMarkup) => data ? escapeMarkup(data.text) : void 0, "formatSelection"),
  formatSelectionCssClass: /* @__PURE__ */ __name(function() {
    return void 0;
  }, "formatSelectionCssClass"),
  formatSelectionTooBig: /* @__PURE__ */ __name((limit) => fmt("SelectionTooBig", limit), "formatSelectionTooBig"),
  sortResults: /* @__PURE__ */ __name((results) => results, "sortResults"),
  minimumResultsForSearch: 0,
  minimumInputLength: 0,
  maximumInputLength: null,
  maximumSelectionSize: 0,
  id: /* @__PURE__ */ __name(function(e) {
    return e == void 0 ? null : e.id;
  }, "id"),
  matcher: /* @__PURE__ */ __name((term, text2) => _Select2.stripDiacritics("" + text2).toUpperCase().indexOf(_Select2.stripDiacritics("" + term).toUpperCase()) >= 0, "matcher"),
  separator: ",",
  tokenSeparators: [],
  ...
  blurOnChange: false,
  selectOnBlur: false,
  adaptContainerCssClass: /* @__PURE__ */ __name(function(c) {
    return c;
  }, "adaptContainerCssClass"),
  adaptDropdownCssClass: /* @__PURE__ */ __name(function(c) {
    return null;
  }, "adaptDropdownCssClass"),
  nextSearchTerm: /* @__PURE__ */ __name(function(selectedObject, currentSearchTerm) {
    return void 0;
  }, "nextSearchTerm"),
  searchInputPlaceholder: "",
  createSearchChoicePosition: "top",
  shouldFocusInput: /* @__PURE__ */ __name(function(instance) {
  ...
  return function(query) {
    ...
    timeout = window.setTimeout(function() {
      ...
      Object.assign(params, {
        ...
        onError: /* @__PURE__ */ __name(function(response, info) {
          var results = {
            errorInfo: info,
            hasError: true,
            results: response
...
function local(options) {
  var data = options, dataText, tmp, text2 = /* @__PURE__ */ __name(function(item) {
    return "" + item.text;
  }, "text");
  ...
  if (dataItem.text) {
    ...
    if (typeof text2 !== "function") {
      ...
      text2 = /* @__PURE__ */ __name(function(item) {
  ...
  return function(query) {
    ...
    process = /* @__PURE__ */ __name(function(datum, collection) {
      var group, attr3;
      datum = datum[0];
      if (datum.children) {
        group = {};
        for (attr3 in datum) {
          if (datum.hasOwnProperty(attr3)) group[attr3] = datum[attr3];
        }
        group.children = [];
  ...
  return function(query) {
    ...
    if (Array.isArray(result)) {
      result.forEach(function(item) {
        var isObject2 = item.text !== void 0, text2 = isObject2 ? item.text : item;
        if (t === "" || query.matcher(t, text2)) {
          filtered.results.push(isObject2 ? item : { id: item, text: item });
        }
      });
      query.callback(filtered);
    }
...
__name(checkFormatter, "checkFormatter");
...
__name(countResults, "countResults");
...
__name(defaultTokenizer, "defaultTokenizer");
...
__name(cleanupJQueryElements, "cleanupJQueryElements");
var _AbstractSelect2 = class _AbstractSelect2 {
  init(opts) {
    var _a68, _b, _c;
  ...
  prepareOpts(opts) {
    ...
    opts = Object.assign({}, {
      populateResults: /* @__PURE__ */ __name(function(container, results, query) {
        var id = this.opts.id;
        let populate = /* @__PURE__ */ __name(function(results2, container2, depth) {
    ...
    if (select) {
      opts.query = (query) => {
        ...
        let process = /* @__PURE__ */ __name(function(element2, collection) {
          var group;
  ...
  updateResults(initial) {
    ...
    opts.query({
      ...
      callback: /* @__PURE__ */ __name((data2) => {
        var def;
  ...
  initContainerWidth() {
    function resolveContainerWidth() {
      var style2, attrs, matches, i, l, attr3;
      if (this.opts.width === "off") {
        return null;
      } else if (this.opts.width === "element") {
        return this.opts.element.offsetWidth === 0 ? "auto" : this.opts.element.offsetWidth + "px";
      } else if (this.opts.width === "copy" || this.opts.width === "resolve") {
        style2 = this.opts.element.getAttribute("style");
        if (style2) {
          attrs = style2.split(";");
          for (i = 0, l = attrs.length; i < l; i = i + 1) {
            attr3 = attrs[i].replace(/\s/g, "");
            matches = attr3.match(/^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i);
            if (matches !== null && matches.length >= 1)
              return matches[1];
          }
        }
        if (this.opts.width === "resolve") {
          style2 = getComputedStyle(this.opts.element).width;
    ...
    __name(resolveContainerWidth, "resolveContainerWidth");
    ;
...
__name(_AbstractSelect2, "AbstractSelect2");
var AbstractSelect2 = _AbstractSelect2;
var _SingleSelect2 = class _SingleSelect2 extends AbstractSelect2 {
  createContainer() {
  ...
  prepareOpts(opts) {
    ...
    if (opts.element.tagName.toLowerCase() === "select") {
      ...
      opts.initSelection = opts.initSelection || function(element, callback) {
        ...
        var match = null;
        opts.query({
          matcher: /* @__PURE__ */ __name(function(term, text2, el) {
...
__name(_SingleSelect2, "SingleSelect2");
var SingleSelect2 = _SingleSelect2;
var _MultiSelect2 = class _MultiSelect2 extends AbstractSelect2 {
  createContainer() {
    var container = document.createElement("div");
...
__name(_MultiSelect2, "MultiSelect2");
var MultiSelect2 = _MultiSelect2;
  ...
  createSelect2(opt) {
    ...
    select2Opt.query = (query) => {
      ...
      this.el.typeTimeoutFn = () => {
        ...
        try {
          const then = /* @__PURE__ */ __name((result) => {
            delete this.el.queryLoading;
            setActive(false);
            query.callback({
...
// src/ui/editors/editorutils.tsx
var EditorUtils;
((EditorUtils2) => {
  ...
  function setReadonly(elements, value) {
    ...
    for (var i = 0; i < elements.length; i++) {
      ...
      if (!(el instanceof Node)) {
        if (typeof el.set_readOnly === "function") {
          el.set_readOnly(!!value);
          continue;
        }
        el = el.domNode;
        if (!el)
        ...
        if (widget != null && typeof widget.set_readOnly === "function") {
          widget.set_readOnly(!!value);
          continue;
        }
      }
  ...
  __name(setReadonly, "setReadonly");
  EditorUtils2.setReadOnly = setReadonly;
  function setRequired(widget, isRequired) {
    ...
    if (isRequired && !hasSupItem && gridField) {
      Fluent(/* @__PURE__ */ jsx("sup", { title: localText("Controls.PropertyGrid.RequiredHint"), children: "*" })).prependTo(gridField.querySelector(".caption"));
    } else if (!isRequired && hasSupItem) {
      Fluent(hasSupItem).remove();
    }
  }
  EditorUtils2.setRequired = setRequired;
  __name(setRequired, "setRequired");
  ...
  __name(setContainerReadOnly, "setContainerReadOnly");
...
__name(ensureParentOrFragment, "ensureParentOrFragment");
...
__name(handleElementProp, "handleElementProp");
...
__name(createElementFor, "createElementFor");
...
__name(setElementProps, "setElementProps");

// src/ui/widgets/widget.ts
var afterRenderSymbol = Symbol();
...
var _Widget = class _Widget {
  ...
  afterRender(callback) {
    if (!callback)
      return;
    const queue = this[afterRenderSymbol];
    if (!queue)
      callback();
    else
      queue.push(callback);
...
((EditorTypeRegistry2) => {
  const registry = commonTypeRegistry({
    attrKey: null,
    isMatch: /* @__PURE__ */ __name((type) => hasCustomAttribute(type, EditorAttribute, false) || isAssignableFrom(Widget, type), "isMatch"),
    kind: "editor",
    suffix: "Editor",
    loadError: /* @__PURE__ */ __name(function(key) {
...
((FormatterTypeRegistry2) => {
  const registry = commonTypeRegistry({
    attrKey: null,
    isMatch: /* @__PURE__ */ __name((type) => isAssignableFrom(ISlickFormatter, type), "isMatch"),
    kind: "formatter",
    suffix: "Formatter",
    loadError: /* @__PURE__ */ __name(function(key) {
...
((ReflectionUtils2) => {
  ...
  __name(setPropertyValue, "setPropertyValue");
  ...
  __name(makeCamelCase, "makeCamelCase");
})(ReflectionUtils || (ReflectionUtils = {}));

// src/compat/jquery-compat.ts
...
__name(applyJQueryUIFixes, "applyJQueryUIFixes");
...
__name(applyCleanDataPatch, "applyCleanDataPatch");
function applyAjaxCSRFToken($2) {
  var _a68;
  (_a68 = $2 == null ? void 0 : $2.ajaxSetup) == null ? void 0 : _a68.call($2, {
    beforeSend: /* @__PURE__ */ __name(function(xhr, opt) {
...
__name(applyAjaxCSRFToken, "applyAjaxCSRFToken");
...
__name(jQueryPatch, "jQueryPatch");
...
var _PrefixedContext = class _PrefixedContext {
...
__name(_PrefixedContext, "PrefixedContext");
var PrefixedContext = _PrefixedContext;

// src/ui/widgets/toolbar.tsx
function ToolbarButton(tb) {
  const btn = Fluent(
    /* @__PURE__ */ jsx(
      "div",
      {
        class: ["tool-button", tb.cssClass, tb.icon && "icon-tool-button", !tb.title && "no-text"],
        title: !!tb.hint && tb.hint,
        onClick: (e) => {
          var _a68;
          if (tb.onClick && !((_a68 = e.currentTarget) == null ? void 0 : _a68.classList.contains("disabled"))) {
            tb.onClick(e);
          }
        },
        children: /* @__PURE__ */ jsx("span", { class: "button-inner", children: [
          tb.icon && /* @__PURE__ */ jsx(Fragment, { children: [
            /* @__PURE__ */ jsx("i", { class: iconClassName(tb.icon) }),
            " "
          ] }),
          tb.title
        ] })
...
var _Toolbar = class _Toolbar extends (_a3 = Widget) {
  renderContents() {
    let group = /* @__PURE__ */ jsx("div", { class: "tool-group" });
    ...
    for (var i = 0; i < buttons.length; i++) {
      ...
      if (button.separator && currentCount > 0) {
        group = group.parentElement.appendChild(/* @__PURE__ */ jsx("div", { class: "tool-group" }));
        currentCount = 0;
      }
  ...
  createButton(container, tb) {
    ...
    if (tb.separator === "right" || tb.separator === "both") {
      container.appendChild(/* @__PURE__ */ jsx("div", { class: "separator" }));
    }
  ...
  findButton(className2) {
    if (className2 != null && className2.startsWith(".")) {
      className2 = className2.substring(1);
    }
    return Fluent(this.domNode.querySelector("div.tool-button." + className2));
  }
  updateInterface() {
...
_Toolbar = __decorateElement(_init49, 0, "Toolbar", _Toolbar_decorators, _Toolbar);
__name(_Toolbar, "Toolbar");
__runInitializers(_init49, 1, _Toolbar);
var Toolbar = _Toolbar;

// src/ui/helpers/tabsextensions.tsx
var TabsExtensions;
((TabsExtensions2) => {
  ...
  __name(activeTabKey, "activeTabKey");
  ...
  __name(extractTabKey2, "extractTabKey");
  ...
  function initialize(tabs, activeChange) {
    ...
    if ((_a68 = $2 == null ? void 0 : $2.fn) == null ? void 0 : _a68.tabs) {
      ...
      if (ul && !ul.classList.contains("nav-tabs") && !ul.classList.contains("nav-underline")) {
        ...
        const container = tabs.appendChild(/* @__PURE__ */ jsx("div", { class: "tab-content" }));
...
__name(applyCssSizes, "applyCssSizes");
...
__name(handleUIDialogResponsive, "handleUIDialogResponsive");
...
((DialogExtensions2) => {
  ...
  __name(dialogResizable, "dialogResizable");
  ...
  __name(dialogMaximizable, "dialogMaximizable");
...
function registerDialogExtendPlugin() {
  ...
  $2.widget("ui.dialogExtend", {
    ...
    _setState: /* @__PURE__ */ __name(function(state) {
      $2(this.domNode).removeClass("ui-dialog-" + this._state).addClass("ui-dialog-" + state);
      return this._state = state;
    }, "_setState"),
    _initButtons: /* @__PURE__ */ __name(function() {
      var _this = this;
    ...
    _addButton: /* @__PURE__ */ __name(function(name, show, hint, icon) {
      var _this = this;
      var titlebar = $2(this.domNode).closest(".ui-dialog").children(".ui-dialog-titlebar");
    ...
    maximize: /* @__PURE__ */ __name(function() {
    ...
    _restore_maximized: /* @__PURE__ */ __name(function() {
      var el = $2(this.domNode);
    ...
    restore: /* @__PURE__ */ __name(function() {
    ...
    _restore: /* @__PURE__ */ __name(function() {
      if (this._state !== "normal") {
        return this["_restore_" + this._state]();
      }
    }, "_restore"),
    _saveSnapshot: /* @__PURE__ */ __name(function() {
      if (this._state === "normal") {
        var el = $2(this.domNode);
        this._snapshot = {
          config: {
    ...
    _toggleButtons: /* @__PURE__ */ __name(function() {
...
__name(registerDialogExtendPlugin, "registerDialogExtendPlugin");
!registerDialogExtendPlugin() && Fluent.ready(registerDialogExtendPlugin);

// src/ui/dialogs/basedialog.tsx
var _BaseDialog_decorators, _init50, _a4;
_BaseDialog_decorators = [Decorators.registerClass("Serenity.BaseDialog", [IDialog])];
var _BaseDialog = class _BaseDialog extends (_a4 = Widget) {
  static createDefaultElement() {
    return document.body.appendChild(/* @__PURE__ */ jsx("div", { class: "hidden" }));
  }
  constructor(props) {
    super(props);
  ...
  getDialogOptions() {
    ...
    return {
      ...
      size: "lg",
      onClose: /* @__PURE__ */ __name((result) => {
...
_BaseDialog = __decorateElement(_init50, 0, "BaseDialog", _BaseDialog_decorators, _BaseDialog);
__name(_BaseDialog, "BaseDialog");
__runInitializers(_init50, 1, _BaseDialog);
var BaseDialog = _BaseDialog;
...
var _BasePanel = class _BasePanel extends (_a5 = Widget) {
  constructor(props) {
    super(props);
    this.initValidator();
    this.initTabs();
...
_BasePanel = __decorateElement(_init51, 0, "BasePanel", _BasePanel_decorators, _BasePanel);
__name(_BasePanel, "BasePanel");
__runInitializers(_init51, 1, _BasePanel);
var BasePanel = _BasePanel;
...
var _EditorWidget = class _EditorWidget extends (_a6 = Widget) {
  constructor(props) {
    super(props);
  }
  get readOnly() {
    return typeof (this == null ? void 0 : this.get_readOnly) === "function" ? !!this.get_readOnly() : getElementReadOnly(this.domNode);
  }
  set readOnly(value) {
    if (typeof (this == null ? void 0 : this.set_readOnly) === "function") {
...
_EditorWidget = __decorateElement(_init52, 0, "EditorWidget", _EditorWidget_decorators, _EditorWidget);
__name(_EditorWidget, "EditorWidget");
_EditorWidget.typeInfo = Decorators.classType("Serenity.EditorWidget");
__runInitializers(_init52, 1, _EditorWidget);
var EditorWidget = _EditorWidget;
...
var _CascadedWidgetLink = class _CascadedWidgetLink {
...
_CascadedWidgetLink = __decorateElement(_init53, 0, "CascadedWidgetLink", _CascadedWidgetLink_decorators, _CascadedWidgetLink);
__name(_CascadedWidgetLink, "CascadedWidgetLink");
__runInitializers(_init53, 1, _CascadedWidgetLink);
var CascadedWidgetLink = _CascadedWidgetLink;
...
// src/ui/widgets/propertygrid.tsx
function PropertyFieldCaption(props) {
  var _a68, _b, _c;
  const labelWidth = props.item.labelWidth;
  const caption = (_a68 = determineText(props.localTextPrefix, props.item.title, (p) => p + props.item.name)) != null ? _a68 : "";
  return /* @__PURE__ */ jsx(
    "label",
    {
      className: "caption",
      htmlFor: ((_b = props.idPrefix) != null ? _b : "") + props.item.name,
      title: (_c = determineText(props.localTextPrefix, props.item.hint, (p) => p + props.item.name + "_Hint")) != null ? _c : caption,
      style: !!labelWidth && (labelWidth == "0" ? "display: none" : "width: " + labelWidth),
      children: [
        props.item.required && /* @__PURE__ */ jsx("sup", { title: localText("Controls.PropertyGrid.RequiredHint"), children: "*" }),
        caption
      ]
    }
  );
}
__name(PropertyFieldCaption, "PropertyFieldCaption");
function PropertyFieldEditor(props) {
  ...
  let loadingPoint;
  const then = /* @__PURE__ */ __name((editorType2) => {
...
__name(PropertyFieldEditor, "PropertyFieldEditor");
...
__name(PropertyFieldLineBreak, "PropertyFieldLineBreak");
function PropertyField(props) {
  ...
  const fieldElement = /* @__PURE__ */ jsx("div", { class: ["field", item.name, item.cssClass, item.formCssClass], "data-itemname": item.name, children: /* @__PURE__ */ jsx(PropertyFieldCaption, { item, idPrefix, localTextPrefix }) });
  ...
  fieldElement.appendChild(/* @__PURE__ */ jsx("div", { class: "vx" }));
  fieldElement.appendChild(/* @__PURE__ */ jsx("div", { class: "clear" }));
  return fieldElement;
}
__name(PropertyField, "PropertyField");
function PropertyCategoryTitle(props) {
  return /* @__PURE__ */ jsx("div", { className: "category-title", children: determineText(props.localTextPrefix, props.category, (prefix) => prefix + "Categories." + props.category) });
}
__name(PropertyCategoryTitle, "PropertyCategoryTitle");
function PropertyCategory(props) {
  const categoryDiv = /* @__PURE__ */ jsx("div", { class: "category" });
  ...
  if (category) {
    ...
    const title = categoryDiv.appendChild(/* @__PURE__ */ jsx(PropertyCategoryTitle, { category, localTextPrefix }));
    if (collapsed != null) {
      categoryDiv.classList.add("collapsible");
      collapsed && categoryDiv.classList.add("collapsed");
      const icon = title.appendChild(/* @__PURE__ */ jsx("i", { class: faIcon(collapsed ? "plus" : "minus") }));
...
__name(PropertyCategory, "PropertyCategory");
function PropertyTabItem(props) {
  const bs3 = isBS3();
  return /* @__PURE__ */ jsx("li", { role: "tab", className: bs3 ? props.active ? "active" : "" : "nav-item", children: /* @__PURE__ */ jsx(
    "a",
    {
      className: bs3 ? "" : `nav-link ${props.active ? "active" : ""}`,
      "data-bs-toggle": "tab",
      href: !!props.paneId && `#${props.paneId}`,
      "data-tabkey": extractTabKey(props.title),
      children: determineText(props.localTextPrefix, props.title, (prefix) => prefix + "Tabs." + props.title)
    }
  ) });
}
__name(PropertyTabItem, "PropertyTabItem");
function PropertyTabPane(props) {
  return /* @__PURE__ */ jsx("div", { id: props.id, className: `tab-pane fade${props.active ? isBS3() ? " in active" : " show active" : ""}`, role: "tabpanel", children: props.children });
}
__name(PropertyTabPane, "PropertyTabPane");
function PropertyCategories(props) {
  var _a68, _b;
  const categoriesDiv = /* @__PURE__ */ jsx("div", { class: "categories" });
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    if (!categoryEl || priorCategory !== category) {
      categoryEl = categoriesDiv.appendChild(/* @__PURE__ */ jsx(
        PropertyCategory,
        {
          category,
          localTextPrefix,
    ...
    const fieldElement = /* @__PURE__ */ jsx(PropertyField, { item, container: categoryEl, idPrefix, localTextPrefix });
    fieldElements == null ? void 0 : fieldElements.push(fieldElement);
    priorCategory = category;
  }
  return categoriesDiv;
}
__name(PropertyCategories, "PropertyCategories");
function PropertyTabList(props) {
  return /* @__PURE__ */ jsx("ul", { className: "nav nav-underline property-tabs", role: "tablist", children: props == null ? void 0 : props.children });
}
__name(PropertyTabList, "PropertyTabList");
function PropertyTabPanes(_) {
  return /* @__PURE__ */ jsx("div", { class: "tab-content property-panes" });
}
__name(PropertyTabPanes, "PropertyTabPanes");
function PropertyTabs(props) {
  ...
  const createItems = /* @__PURE__ */ __name((container2, items2) => PropertyCategories({
    items: items2,
  ...
  if (itemsWithoutTab.length > 0) {
    ...
    parentNode.appendChild(/* @__PURE__ */ jsx("div", { class: "pad" }));
  }
...
__name(PropertyTabs, "PropertyTabs");
...
var _PropertyGrid = class _PropertyGrid extends (_a7 = Widget) {
  ...
  static updateFieldElement(fieldElement, mode, canModify) {
    ...
    var editor = fieldElement.editorWidget;
    const then = /* @__PURE__ */ __name((editor2) => {
      if (!editor2)
        return;
...
__name(determineText, "determineText");
...
__name(extractTabKey, "extractTabKey");
...
__name(setMaxLength, "setMaxLength");
function createLineBreak(klass) {
  return /* @__PURE__ */ jsx("div", { className: klass, style: "width: 100%" });
}
__name(createLineBreak, "createLineBreak");
...
var _PropertyPanel = class _PropertyPanel extends (_a8 = BasePanel) {
  constructor(props) {
    super(props);
  ...
  getFormKey() {
    var attr3 = this.getCustomAttribute(FormKeyAttribute);
    if (attr3) {
      return attr3.value;
    }
...
_PropertyPanel = __decorateElement(_init55, 0, "PropertyPanel", _PropertyPanel_decorators, _PropertyPanel);
__name(_PropertyPanel, "PropertyPanel");
__runInitializers(_init55, 1, _PropertyPanel);
...
((SubDialogHelper2) => {
  ...
  __name(bindToDataChange, "bindToDataChange");
  ...
  __name(triggerDataChange, "triggerDataChange");
  ...
  __name(triggerDataChanged, "triggerDataChanged");
  ...
  __name(bubbleDataChange, "bubbleDataChange");
  ...
  __name(cascadedDialogOffset, "cascadedDialogOffset");
})(SubDialogHelper || (SubDialogHelper = {}));

// src/ui/dialogs/propertydialog.tsx
...
var _PropertyDialog = class _PropertyDialog extends (_a9 = BaseDialog) {
  ...
  renderContents() {
    ...
    return /* @__PURE__ */ jsx("div", { class: "s-Form", children: /* @__PURE__ */ jsx("form", { id: id.Form, action: "", children: /* @__PURE__ */ jsx("div", { id: id.PropertyGrid }) }) });
  }
};
...
__name(_PropertyDialog, "PropertyDialog");
__runInitializers(_init56, 1, _PropertyDialog);
var PropertyDialog = _PropertyDialog;

// src/ui/editors/stringeditor.tsx
var _StringEditor_decorators, _init57, _a10;
_StringEditor_decorators = [Decorators.registerType()];
var _StringEditor = class _StringEditor extends (_a10 = EditorWidget) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "text" });
  }
  get value() {
...
_StringEditor = __decorateElement(_init57, 0, "StringEditor", _StringEditor_decorators, _StringEditor);
__name(_StringEditor, "StringEditor");
_StringEditor.typeInfo = Decorators.editorType("Serenity.StringEditor", [IStringValue]);
__runInitializers(_init57, 1, _StringEditor);
var StringEditor = _StringEditor;

// src/ui/editors/passwordeditor.tsx
var _PasswordEditor_decorators, _init58, _a11;
_PasswordEditor_decorators = [Decorators.registerType()];
var _PasswordEditor = class _PasswordEditor extends (_a11 = StringEditor) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "password" });
  }
};
_init58 = __decoratorStart(_a11);
_PasswordEditor = __decorateElement(_init58, 0, "PasswordEditor", _PasswordEditor_decorators, _PasswordEditor);
__name(_PasswordEditor, "PasswordEditor");
_PasswordEditor.typeInfo = Decorators.editorType("Serenity.PasswordEditor");
__runInitializers(_init58, 1, _PasswordEditor);
var PasswordEditor = _PasswordEditor;
...
var _TextAreaEditor = class _TextAreaEditor extends (_a12 = EditorWidget) {
  static createDefaultElement() {
...
_TextAreaEditor = __decorateElement(_init59, 0, "TextAreaEditor", _TextAreaEditor_decorators, _TextAreaEditor);
__name(_TextAreaEditor, "TextAreaEditor");
__runInitializers(_init59, 1, _TextAreaEditor);
var TextAreaEditor = _TextAreaEditor;

// src/ui/editors/booleaneditor.tsx
...
var _BooleanEditor = class _BooleanEditor extends (_a13 = EditorWidget) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "checkbox" });
  }
  get value() {
...
_BooleanEditor = __decorateElement(_init60, 0, "BooleanEditor", _BooleanEditor_decorators, _BooleanEditor);
__name(_BooleanEditor, "BooleanEditor");
__runInitializers(_init60, 1, _BooleanEditor);
var BooleanEditor = _BooleanEditor;
...
__name(getElementSelection, "getElementSelection");
...
__name(setElementSelection, "setElementSelection");
...
__name(convertKeyToNumber, "convertKeyToNumber");
...
__name(negativeBracket, "negativeBracket");
...
__name(truncateDecimal, "truncateDecimal");
...
__name(presentNumber, "presentNumber");
...
function autoRound(iv, settings) {
  ...
  var truncateZeros = /* @__PURE__ */ __name(function(ivRounded2) {
...
__name(autoRound, "autoRound");
var _AutoNumericHolder = class _AutoNumericHolder {
...
__name(_AutoNumericHolder, "AutoNumericHolder");
var AutoNumericHolder = _AutoNumericHolder;
...
var _AutoNumeric = class _AutoNumeric {
...
__name(_AutoNumeric, "AutoNumeric");
var AutoNumeric = _AutoNumeric;

// src/ui/editors/decimaleditor.tsx
...
var _IntegerEditor = class _IntegerEditor extends (_a15 = EditorWidget) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "text" });
  }
  constructor(props) {
...
_IntegerEditor = __decorateElement(_init62, 0, "IntegerEditor", _IntegerEditor_decorators, _IntegerEditor);
__name(_IntegerEditor, "IntegerEditor");
__runInitializers(_init62, 1, _IntegerEditor);
var IntegerEditor = _IntegerEditor;
...
__name(dateInputChangeHandler, "dateInputChangeHandler");
...
__name(dateInputKeyupHandler, "dateInputKeyupHandler");
...
__name(flatPickrTrigger, "flatPickrTrigger");
...
__name(jQueryDatepickerZIndexWorkaround, "jQueryDatepickerZIndexWorkaround");
...
__name(jQueryDatepickerInitialization, "jQueryDatepickerInitialization");
...
var _DateEditor = class _DateEditor extends (_a16 = EditorWidget) {
  ...
  constructor(props) {
    ...
    if (typeof flatpickr !== "undefined" && (_DateEditor.useFlatpickr || !((_a68 = $2 == null ? void 0 : $2.fn) == null ? void 0 : _a68.datepicker))) {
      ...
      $2(this.domNode).datepicker({
        showOn: "button",
        beforeShow: /* @__PURE__ */ __name((inp, inst) => {
  ...
  getFlatpickrOptions(input) {
    ...
    if (this.domNode.closest(".modal"))
      ...
      setTimeout(() => {
        var _a68;
        var modal = (_a68 = this.domNode) == null ? void 0 : _a68.closest(".modal");
...
__name(_DateEditor, "DateEditor");
_DateEditor.dateInputChange = /* @__PURE__ */ __name(function(e) {
...
var _DateTimeEditor = class _DateTimeEditor extends (_a17 = EditorWidget) {
  ...
  constructor(props) {
    ...
    if (this.options.inputOnly) {
      ...
      this.time = /* @__PURE__ */ jsx("select", { class: "editor s-DateTimeEditor time" });
    ...
    this.set_sqlMinMax(true);
    if (!this.options.inputOnly) {
      ((_g = this.time) != null ? _g : this.domNode).after(
        /* @__PURE__ */ jsx("i", { class: "inplace-button inplace-now", title: this.getInplaceNowText(), onClick: () => {
          if (this.get_readOnly())
            return;
          this.setToNow(true);
  ...
  getFlatpickrOptions() {
    ...
    if (this.domNode.closest(".modal"))
      ...
      setTimeout(() => {
        var _a69;
        var modal = (_a69 = this.domNode) == null ? void 0 : _a69.closest(".modal");
        if (modal && !opt.static && !opt.appendTo && this.domNode && this.domNode._flatpickr && this.domNode._flatpickr.calendarContainer && this.domNode._flatpickr.calendarContainer.parentElement !== modal) {
          modal.appendChild(this.domNode._flatpickr.calendarContainer);
        }
      }, 0);
...
__name(_DateTimeEditor, "DateTimeEditor");
_DateTimeEditor.getTimeOptions = /* @__PURE__ */ __name(function(fromHour, fromMin, toHour, toMin, stepMins) {
  var list = [];
  if (toHour >= 23) {
    toHour = 23;
  }
...
var _TimeEditorBase = class _TimeEditorBase extends EditorWidget {
  static createDefaultElement() {
...
__name(_TimeEditorBase, "TimeEditorBase");
var TimeEditorBase = _TimeEditorBase;
...
var _TimeEditor = class _TimeEditor extends (_a18 = TimeEditorBase) {
  constructor(props) {
    super(props);
...
_TimeEditor = __decorateElement(_init65, 0, "TimeEditor", _TimeEditor_decorators, _TimeEditor);
__name(_TimeEditor, "TimeEditor");
__runInitializers(_init65, 1, _TimeEditor);
...
var _TimeSpanEditor = class _TimeSpanEditor extends (_a19 = TimeEditorBase) {
  constructor(props) {
    super(props);
...
_TimeSpanEditor = __decorateElement(_init66, 0, "TimeSpanEditor", _TimeSpanEditor_decorators, _TimeSpanEditor);
__name(_TimeSpanEditor, "TimeSpanEditor");
__runInitializers(_init66, 1, _TimeSpanEditor);
var TimeSpanEditor = _TimeSpanEditor;

// src/ui/editors/emaileditor.tsx
...
var _EmailEditor = class _EmailEditor extends (_a20 = EditorWidget) {
  ...
  constructor(props) {
    ...
    this.domain = /* @__PURE__ */ jsx("input", { type: "text", class: "emaildomain" });
    this.domNode.after(/* @__PURE__ */ jsx(Fragment, { children: [
      /* @__PURE__ */ jsx("span", { class: "emailat", children: "@" }),
      this.domain
    ] }));
    ...
    Fluent.on(this.domain, "keypress." + this.uniqueName, function(e) {
      if (e.key === "@")
        e.preventDefault();
    });
    if (!this.options.readOnlyDomain) {
...
__name(_EmailEditor, "EmailEditor");
__runInitializers(_init67, 1, _EmailEditor);
var EmailEditor = _EmailEditor;

// src/ui/editors/emailaddresseditor.tsx
...
var _EmailAddressEditor = class _EmailAddressEditor extends (_a21 = StringEditor) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "email" });
  }
  constructor(props) {
    var _a68;
    super(props);
...
_EmailAddressEditor = __decorateElement(_init68, 0, "EmailAddressEditor", _EmailAddressEditor_decorators, _EmailAddressEditor);
__name(_EmailAddressEditor, "EmailAddressEditor");
__runInitializers(_init68, 1, _EmailAddressEditor);
var EmailAddressEditor = _EmailAddressEditor;
...
var _URLEditor = class _URLEditor extends (_a22 = StringEditor) {
  constructor(props) {
    super(props);
...
_URLEditor = __decorateElement(_init69, 0, "URLEditor", _URLEditor_decorators, _URLEditor);
__name(_URLEditor, "URLEditor");
__runInitializers(_init69, 1, _URLEditor);
var URLEditor = _URLEditor;

// src/ui/editors/radiobuttoneditor.tsx
...
var _RadioButtonEditor = class _RadioButtonEditor extends (_a23 = EditorWidget) {
  constructor(props) {
    super(props);
    ...
    if (this.options.lookupKey) {
      ...
      const then = /* @__PURE__ */ __name((enumType2) => {
        var _a68;
  ...
  addRadio(value, text2) {
    this.domNode.appendChild(/* @__PURE__ */ jsx("label", { children: [
      /* @__PURE__ */ jsx("input", { type: "radio", name: this.uniqueName, id: this.uniqueName + "_" + value, value }),
      text2
    ] }));
  }
  get_value() {
...
_RadioButtonEditor = __decorateElement(_init70, 0, "RadioButtonEditor", _RadioButtonEditor_decorators, _RadioButtonEditor);
__name(_RadioButtonEditor, "RadioButtonEditor");
__runInitializers(_init70, 1, _RadioButtonEditor);
var RadioButtonEditor = _RadioButtonEditor;

// src/ui/editors/comboboxeditor.tsx
...
var _ComboboxEditor = class _ComboboxEditor extends (_a24 = EditorWidget) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "hidden" });
  }
  constructor(props) {
    super(props);
    ...
    if (this.hasAsyncSource()) {
      opt.search = (query) => this.asyncSearch(query).then((result) => {
        ...
        if (query.initSelection) {
          ...
          const newItems = (query.idList || []).map((id) => itemById[id]).filter((x2) => x2 != null);
  ...
  addInplaceCreate(addTitle, editTitle) {
    ...
    const inplaceButton = /* @__PURE__ */ jsx("a", { class: "inplace-button inplace-create", title: addTitle, onClick: (e) => {
  ...
  createEditDialog(callback) {
    ...
    const then = /* @__PURE__ */ __name((dialogType2) => {
      var _a68, _b;
...
__name(_ComboboxEditor, "ComboboxEditor");
...
var _SelectEditor = class _SelectEditor extends (_a25 = ComboboxEditor) {
  constructor(props) {
    super(props);
    this.updateItems();
  }
...
_SelectEditor = __decorateElement(_init72, 0, "SelectEditor", _SelectEditor_decorators, _SelectEditor);
__name(_SelectEditor, "SelectEditor");
__runInitializers(_init72, 1, _SelectEditor);
...
var _DateYearEditor = class _DateYearEditor extends (_a26 = SelectEditor) {
  constructor(props) {
    super(props);
    this.updateItems();
  }
...
_DateYearEditor = __decorateElement(_init73, 0, "DateYearEditor", _DateYearEditor_decorators, _DateYearEditor);
__name(_DateYearEditor, "DateYearEditor");
__runInitializers(_init73, 1, _DateYearEditor);
var DateYearEditor = _DateYearEditor;
...
var _EnumEditor = class _EnumEditor extends (_a27 = ComboboxEditor) {
  constructor(props) {
    super(props);
    this.updateItems();
  }
...
_EnumEditor = __decorateElement(_init74, 0, "EnumEditor", _EnumEditor_decorators, _EnumEditor);
__name(_EnumEditor, "EnumEditor");
__runInitializers(_init74, 1, _EnumEditor);
var EnumEditor = _EnumEditor;
...
var _LookupEditorBase = class _LookupEditorBase extends (_a28 = ComboboxEditor) {
  constructor(props) {
    super(props);
    if (!this.hasAsyncSource()) {
      this.updateItems();
...
_LookupEditorBase = __decorateElement(_init75, 0, "LookupEditorBase", _LookupEditorBase_decorators, _LookupEditorBase);
__name(_LookupEditorBase, "LookupEditorBase");
__runInitializers(_init75, 1, _LookupEditorBase);
var LookupEditorBase = _LookupEditorBase;
var _LookupEditor_decorators, _init76, _a29;
_LookupEditor_decorators = [Decorators.registerEditor("Serenity.LookupEditor")];
var _LookupEditor = class _LookupEditor extends (_a29 = LookupEditorBase) {
  constructor(props) {
    super(props);
  }
};
_init76 = __decoratorStart(_a29);
_LookupEditor = __decorateElement(_init76, 0, "LookupEditor", _LookupEditor_decorators, _LookupEditor);
__name(_LookupEditor, "LookupEditor");
__runInitializers(_init76, 1, _LookupEditor);
var LookupEditor = _LookupEditor;
...
var _ServiceLookupEditorBase = class _ServiceLookupEditorBase extends (_a30 = ComboboxEditor) {
  getDialogTypeKey() {
    var dialogTypeKey = super.getDialogTypeKey();
    if (dialogTypeKey)
      return dialogTypeKey;
...
_ServiceLookupEditorBase = __decorateElement(_init77, 0, "ServiceLookupEditorBase", _ServiceLookupEditorBase_decorators, _ServiceLookupEditorBase);
__name(_ServiceLookupEditorBase, "ServiceLookupEditorBase");
__runInitializers(_init77, 1, _ServiceLookupEditorBase);
var ServiceLookupEditorBase = _ServiceLookupEditorBase;
...
var _ServiceLookupEditor = class _ServiceLookupEditor extends (_a31 = ServiceLookupEditorBase) {
  constructor(props) {
    super(props);
  }
};
_init78 = __decoratorStart(_a31);
_ServiceLookupEditor = __decorateElement(_init78, 0, "ServiceLookupEditor", _ServiceLookupEditor_decorators, _ServiceLookupEditor);
__name(_ServiceLookupEditor, "ServiceLookupEditor");
__runInitializers(_init78, 1, _ServiceLookupEditor);
var ServiceLookupEditor = _ServiceLookupEditor;

// src/ui/editors/htmlcontenteditor.tsx
...
var _HtmlContentEditor = class _HtmlContentEditor extends (_a32 = EditorWidget) {
  ...
  getConfig() {
    return {
      ...
      versionCheck: false,
      on: {
        instanceReady: /* @__PURE__ */ __name((x) => this.instanceReady(x), "instanceReady"),
        change: /* @__PURE__ */ __name((x1) => {
    ...
    document.head.appendChild(
      /* @__PURE__ */ jsx(
        "script",
        {
          ...
          async: false,
          onLoad: then,
          src: resolveUrl(_HtmlContentEditor.getCKEditorBasePath() + "ckeditor.js?v=" + _HtmlContentEditor.CKEditorVer)
        }
      )
    );
  }
...
__name(_HtmlContentEditor, "HtmlContentEditor");
...
var _HtmlNoteContentEditor = class _HtmlNoteContentEditor extends (_a33 = HtmlContentEditor) {
  getConfig() {
...
_HtmlNoteContentEditor = __decorateElement(_init80, 0, "HtmlNoteContentEditor", _HtmlNoteContentEditor_decorators, _HtmlNoteContentEditor);
__name(_HtmlNoteContentEditor, "HtmlNoteContentEditor");
__runInitializers(_init80, 1, _HtmlNoteContentEditor);
var HtmlNoteContentEditor = _HtmlNoteContentEditor;
...
var _HtmlReportContentEditor = class _HtmlReportContentEditor extends (_a34 = HtmlContentEditor) {
  getConfig() {
    var config = super.getConfig();
    config.removeButtons += ",Cut,Copy,Paste,BulletedList,NumberedList,Indent,Outdent,SpecialChar,Subscript,Superscript,Styles,PasteText,PasteFromWord,Strike,Link,Unlink,CreatePlaceholder,Image,Table,HorizontalRule,Source,Maximize,Format,Font,FontSize,Anchor,Blockquote,CreatePlaceholder,BGColor,JustifyLeft,JustifyCenter,JustifyRight,JustifyBlock,Superscript,RemoveFormat";
    config.removePlugins = "elementspath,uploadimage,image2";
...
_HtmlReportContentEditor = __decorateElement(_init81, 0, "HtmlReportContentEditor", _HtmlReportContentEditor_decorators, _HtmlReportContentEditor);
__name(_HtmlReportContentEditor, "HtmlReportContentEditor");
__runInitializers(_init81, 1, _HtmlReportContentEditor);
var HtmlReportContentEditor = _HtmlReportContentEditor;

// src/ui/editors/maskededitor.tsx
...
var _MaskedEditor = class _MaskedEditor extends (_a35 = EditorWidget) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "text" });
  }
  constructor(props) {
...
_MaskedEditor = __decorateElement(_init82, 0, "MaskedEditor", _MaskedEditor_decorators, _MaskedEditor);
__name(_MaskedEditor, "MaskedEditor");
__runInitializers(_init82, 1, _MaskedEditor);
var MaskedEditor = _MaskedEditor;
...
var _Recaptcha = class _Recaptcha extends (_a36 = EditorWidget) {
  constructor(props) {
    var _a68;
    super(props);
...
_Recaptcha = __decorateElement(_init83, 0, "Recaptcha", _Recaptcha_decorators, _Recaptcha);
__name(_Recaptcha, "Recaptcha");
__runInitializers(_init83, 1, _Recaptcha);
var Recaptcha = _Recaptcha;

// src/ui/helpers/uploadhelper.tsx
var UploadHelper;
((UploadHelper2) => {
  function addUploadInput(options) {
    ...
    var uploadInput = Fluent(/* @__PURE__ */ jsx("input", { type: "file", name: options.inputName + "[]", "data-url": resolveUrl(uploadUrl), multiple: !!options.allowMultiple })).appendTo(container);
    const setProgress = /* @__PURE__ */ __name((percent) => {
      let bar = progress.children()[0];
      bar && (bar.style.width = (percent != null ? percent : 0).toString() + "%");
    }, "setProgress");
    var uploader = new Uploader({
      batchSize: 1,
      batchSuccess: /* @__PURE__ */ __name((data) => {
        var _a69, _b2, _c, _d;
      ...
      batchStart: /* @__PURE__ */ __name(() => {
        blockUI(null);
        progress.show();
        setProgress(0);
      }, "batchStart"),
      batchStop: /* @__PURE__ */ __name(() => {
        blockUndo();
        setProgress(100);
        progress.hide();
      }, "batchStop"),
      batchProgress: /* @__PURE__ */ __name((data) => {
  ...
  __name(addUploadInput, "addUploadInput");
  ...
  __name(checkImageConstraints, "checkImageConstraints");
  ...
  __name(fileNameSizeDisplay, "fileNameSizeDisplay");
  ...
  __name(fileSizeDisplay, "fileSizeDisplay");
  ...
  __name(hasImageExtension, "hasImageExtension");
  ...
  __name(thumbFileName, "thumbFileName");
  ...
  function populateFileSymbols(c, items, displayOriginalName, urlPrefix) {
    ...
    for (var index = 0; index < items.length; index++) {
      ...
      const originalName = (_a68 = item.OriginalName) != null ? _a68 : "";
      let fileName = item.Filename;
      if (urlPrefix != null && fileName != null && !fileName.startsWith("temporary/")) {
        fileName = urlPrefix + fileName;
      }
      const thumb = /* @__PURE__ */ jsx("a", { class: "thumb", href: dbFileUrl(fileName), target: "_blank" });
      if (originalName) {
      ...
      container.appendChild(
        /* @__PURE__ */ jsx("li", { class: ["file-item", isImage ? "file-image" : "file-binary"], "data-index": index, children: [
          thumb,
          displayOriginalName && /* @__PURE__ */ jsx("div", { class: "filename", title: originalName, children: originalName })
        ] })
      );
    }
  }
  UploadHelper2.populateFileSymbols = populateFileSymbols;
  __name(populateFileSymbols, "populateFileSymbols");
})(UploadHelper || (UploadHelper = {}));

// src/ui/editors/uploadeditors.tsx
...
var _FileUploadEditor = class _FileUploadEditor extends (_a37 = EditorWidget) {
  constructor(props) {
    super(props);
    ...
    this.toolbar = new Toolbar({
      ...
      element: /* @__PURE__ */ __name((el) => this.domNode.appendChild(el), "element")
    }).init();
    this.progress = this.toolbar.domNode.appendChild(/* @__PURE__ */ jsx("div", { class: "upload-progress", children: /* @__PURE__ */ jsx("div", {}) }));
    var uio = this.getUploadInputOptions();
    this.uploadInput = UploadHelper.addUploadInput(uio);
    if (this.options.readOnly)
      this.set_readOnly(true);
    this.fileSymbols = this.domNode.appendChild(/* @__PURE__ */ jsx("ul", { class: "file-items" }));
    if (!this.domNode.id) {
      this.domNode.id = this.uniqueName;
    }
    this.hiddenInput = this.domNode.appendChild(/* @__PURE__ */ jsx(
      "input",
      {
        class: "s-offscreen",
        type: "text",
        name: this.uniqueName + "_Validator",
        "data-vx-highlight": this.domNode.id
      }
    ));
    this.updateInterface();
  }
  getUploadInputOptions() {
    return {
      ...
      fileDone: /* @__PURE__ */ __name((response, name, data) => {
  ...
  populate() {
    ...
    this.hiddenInput.value = ((_a68 = (this.get_value() || {}).Filename) == null ? void 0 : _a68.trim()) || null;
  }
  updateInterface() {
...
_FileUploadEditor = __decorateElement(_init84, 0, "FileUploadEditor", _FileUploadEditor_decorators, _FileUploadEditor);
__name(_FileUploadEditor, "FileUploadEditor");
__runInitializers(_init84, 1, _FileUploadEditor);
var FileUploadEditor = _FileUploadEditor;
...
var _ImageUploadEditor = class _ImageUploadEditor extends (_a38 = FileUploadEditor) {
  constructor(props) {
    super(props);
...
_ImageUploadEditor = __decorateElement(_init85, 0, "ImageUploadEditor", _ImageUploadEditor_decorators, _ImageUploadEditor);
__name(_ImageUploadEditor, "ImageUploadEditor");
__runInitializers(_init85, 1, _ImageUploadEditor);
var ImageUploadEditor = _ImageUploadEditor;
...
var _MultipleFileUploadEditor = class _MultipleFileUploadEditor extends (_a39 = EditorWidget) {
  constructor(props) {
    super(props);
    this.entities = [];
    ...
    this.toolbar = new Toolbar({
      buttons: this.getToolButtons(),
      element: /* @__PURE__ */ __name((el) => this.domNode.append(el), "element")
    }).init();
    this.progress = this.toolbar.domNode.appendChild(/* @__PURE__ */ jsx("div", { class: "upload-progress", children: /* @__PURE__ */ jsx("div", {}) }));
    ...
    this.hiddenInput = /* @__PURE__ */ jsx("input", { class: "s-offscreen", type: "text", name: this.uniqueName + "_Validator", "data-vx-highlight": this.domNode.id, multiple: true });
    this.updateInterface();
  }
  getUploadInputOptions() {
    ...
    return {
      ...
      uploadUrl: this.options.uploadUrl,
      allowMultiple: true,
      fileDone: /* @__PURE__ */ __name((response, name) => {
        if (!UploadHelper.checkImageConstraints(response, this.options)) {
          return;
        }
  ...
  populate() {
    ...
    this.fileSymbols.childNodes.forEach((e, i) => {
      var x = i;
      Fluent(/* @__PURE__ */ jsx("a", { class: "delete" })).appendTo(Fluent(e).children().find((x2) => x2.matches(".filename"))).on("click", (ev) => {
        ev.preventDefault();
    ...
    this.hiddenInput.value = ((_a68 = this.get_value()[0]) == null ? void 0 : _a68.Filename) || null;
  }
  updateInterface() {
    var addButton = this.toolbar.findButton("add-file-button");
    addButton.toggleClass("disabled", this.get_readOnly());
...
_MultipleFileUploadEditor = __decorateElement(_init86, 0, "MultipleFileUploadEditor", _MultipleFileUploadEditor_decorators, _MultipleFileUploadEditor);
__name(_MultipleFileUploadEditor, "MultipleFileUploadEditor");
__runInitializers(_init86, 1, _MultipleFileUploadEditor);
var MultipleFileUploadEditor = _MultipleFileUploadEditor;
...
var _MultipleImageUploadEditor = class _MultipleImageUploadEditor extends (_a40 = MultipleFileUploadEditor) {
  constructor(props) {
    super(props);
...
_MultipleImageUploadEditor = __decorateElement(_init87, 0, "MultipleImageUploadEditor", _MultipleImageUploadEditor_decorators, _MultipleImageUploadEditor);
__name(_MultipleImageUploadEditor, "MultipleImageUploadEditor");
__runInitializers(_init87, 1, _MultipleImageUploadEditor);
var MultipleImageUploadEditor = _MultipleImageUploadEditor;
...
__name(_FilterStore, "FilterStore");
__runInitializers(_init88, 1, _FilterStore);
var FilterStore = _FilterStore;
var _mkdel = /* @__PURE__ */ __name((targets) => {
  var delegate = /* @__PURE__ */ __name(function() {
    if (targets.length === 2) {
...
__name(delegateCombine, "delegateCombine");
...
__name(delegateRemove, "delegateRemove");
...
__name(delegateContains, "delegateContains");

// src/ui/datagrid/quickfilterbar.tsx
...
var _QuickFilterBar = class _QuickFilterBar extends (_a41 = Widget) {
  ...
  addSeparator() {
    this.domNode.append(/* @__PURE__ */ jsx("hr", {}));
  }
  add(opt) {
    var _a68, _b;
    if (opt == null) {
    ...
    const qfElement = this.domNode.appendChild(/* @__PURE__ */ jsx("div", { class: "quick-filter-item", "data-qffield": opt.field }));
    ...
    qfElement.appendChild(/* @__PURE__ */ jsx("span", { class: "quick-filter-label", children: title }));
    ...
    var submitHandler = /* @__PURE__ */ __name((request) => {
  ...
  static dateRange(field, title) {
    ...
    return {
      ...
      element: /* @__PURE__ */ __name(function(el) {
        end = new DateEditor({ element: /* @__PURE__ */ __name((el2) => Fluent(el2).insertAfter(el), "element") });
        Fluent.on(end.domNode, "change", () => el.trigger("change"));
        el.after(/* @__PURE__ */ jsx("span", { class: "range-separator", children: "-" }));
      }, "element"),
      handler: /* @__PURE__ */ __name(function(args) {
      ...
      displayText: /* @__PURE__ */ __name(function(w, l) {
        var _a68;
      ...
      saveState: /* @__PURE__ */ __name(function(w1) {
        return [EditorUtils.getValue(w1), EditorUtils.getValue(end)];
      }, "saveState"),
      loadState: /* @__PURE__ */ __name(function(w2, state) {
  ...
  static dateTimeRange(field, title, useUtc) {
    ...
    return {
      ...
      element: /* @__PURE__ */ __name(function(el) {
          ...
          element: /* @__PURE__ */ __name((el2) => Fluent(el2).insertAfter(el), "element"),
          useUtc: useUtc == null ? void 0 : useUtc
        });
        Fluent.on(end.domNode, "change", () => el.trigger("change"));
        el.after(/* @__PURE__ */ jsx("span", { class: "range-separator", children: "-" }));
      }, "element"),
      init: /* @__PURE__ */ __name(function(w) {
        var _a68;
...
var _QuickSearchInput = class _QuickSearchInput extends (_a42 = Widget) {
  static createDefaultElement() {
    return /* @__PURE__ */ jsx("input", { type: "text" });
  }
  constructor(props) {
    ...
    this.domNode.before(/* @__PURE__ */ jsx("span", { class: "quick-search-icon", children: /* @__PURE__ */ jsx("i", {}) }));
    if ((_b = this.options.fields) == null ? void 0 : _b.length) {
      this.domNode.before(
        /* @__PURE__ */ jsx("div", { class: "dropdown quick-search-field", children: [
          /* @__PURE__ */ jsx("a", { class: "quick-search-field-toggle", title: localText("Controls.QuickSearch.FieldSelection"), "data-bs-toggle": "dropdown", ref: (el) => this.fieldLink = el }),
          /* @__PURE__ */ jsx("ul", { class: "dropdown-menu", children: this.options.fields.map((item) => {
            var _a69;
            return /* @__PURE__ */ jsx("a", { class: "dropdown-item", href: "#", onClick: (e) => {
              e.preventDefault();
              this.fieldChanged = item !== this.field;
              this.field = item;
              this.updateInputPlaceHolder();
              this.checkIfValueChanged();
            }, children: (_a69 = item.title) != null ? _a69 : "" });
          }) })
        ] })
      );
  ...
  searchNow(value) {
    ...
    var done = /* @__PURE__ */ __name((results) => {
      var _a69, _b2;
...
_QuickSearchInput = __decorateElement(_init90, 0, "QuickSearchInput", _QuickSearchInput_decorators, _QuickSearchInput);
__name(_QuickSearchInput, "QuickSearchInput");
__runInitializers(_init90, 1, _QuickSearchInput);
var QuickSearchInput = _QuickSearchInput;
...
var _IFiltering = class _IFiltering {
};
_init91 = __decoratorStart(null);
_IFiltering = __decorateElement(_init91, 0, "IFiltering", _IFiltering_decorators, _IFiltering);
__name(_IFiltering, "IFiltering");
__runInitializers(_init91, 1, _IFiltering);
var IFiltering = _IFiltering;
var _IQuickFiltering_decorators, _init92;
_IQuickFiltering_decorators = [Decorators.registerInterface("Serenity.IQuickFiltering")];
var _IQuickFiltering = class _IQuickFiltering {
};
_init92 = __decoratorStart(null);
_IQuickFiltering = __decorateElement(_init92, 0, "IQuickFiltering", _IQuickFiltering_decorators, _IQuickFiltering);
__name(_IQuickFiltering, "IQuickFiltering");
__runInitializers(_init92, 1, _IQuickFiltering);
var IQuickFiltering = _IQuickFiltering;
...
var _BaseFiltering = class _BaseFiltering {
  get_field() {
    return this.field;
  }
  set_field(value) {
...
_BaseFiltering = __decorateElement(_init93, 0, "BaseFiltering", _BaseFiltering_decorators, _BaseFiltering);
__name(_BaseFiltering, "BaseFiltering");
__runInitializers(_init93, 1, _BaseFiltering);
var BaseFiltering = _BaseFiltering;
function Filtering(name) {
  return Decorators.registerClass("Serenity." + name + "Filtering");
}
__name(Filtering, "Filtering");
var _BaseEditorFiltering_decorators, _init94, _a43;
_BaseEditorFiltering_decorators = [Filtering("BaseEditor")];
var _BaseEditorFiltering = class _BaseEditorFiltering extends (_a43 = BaseFiltering) {
...
_BaseEditorFiltering = __decorateElement(_init94, 0, "BaseEditorFiltering", _BaseEditorFiltering_decorators, _BaseEditorFiltering);
__name(_BaseEditorFiltering, "BaseEditorFiltering");
__runInitializers(_init94, 1, _BaseEditorFiltering);
var BaseEditorFiltering = _BaseEditorFiltering;
var _DateFiltering_decorators, _init95, _a44;
_DateFiltering_decorators = [Filtering("Date")];
var _DateFiltering = class _DateFiltering extends (_a44 = BaseEditorFiltering) {
  constructor() {
    super(DateEditor);
  }
  getOperators() {
...
_DateFiltering = __decorateElement(_init95, 0, "DateFiltering", _DateFiltering_decorators, _DateFiltering);
__name(_DateFiltering, "DateFiltering");
__runInitializers(_init95, 1, _DateFiltering);
var DateFiltering = _DateFiltering;
var _BooleanFiltering_decorators, _init96, _a45;
_BooleanFiltering_decorators = [Filtering("Boolean")];
var _BooleanFiltering = class _BooleanFiltering extends (_a45 = BaseFiltering) {
  getOperators() {
...
_BooleanFiltering = __decorateElement(_init96, 0, "BooleanFiltering", _BooleanFiltering_decorators, _BooleanFiltering);
__name(_BooleanFiltering, "BooleanFiltering");
__runInitializers(_init96, 1, _BooleanFiltering);
var BooleanFiltering = _BooleanFiltering;
var _DateTimeFiltering_decorators, _init97, _a46;
_DateTimeFiltering_decorators = [Filtering("DateTime")];
var _DateTimeFiltering = class _DateTimeFiltering extends (_a46 = BaseEditorFiltering) {
  constructor() {
...
_DateTimeFiltering = __decorateElement(_init97, 0, "DateTimeFiltering", _DateTimeFiltering_decorators, _DateTimeFiltering);
__name(_DateTimeFiltering, "DateTimeFiltering");
__runInitializers(_init97, 1, _DateTimeFiltering);
var DateTimeFiltering = _DateTimeFiltering;
var _DecimalFiltering_decorators, _init98, _a47;
_DecimalFiltering_decorators = [Filtering("Decimal")];
var _DecimalFiltering = class _DecimalFiltering extends (_a47 = BaseEditorFiltering) {
  constructor() {
    super(DecimalEditor);
  }
  getOperators() {
...
_DecimalFiltering = __decorateElement(_init98, 0, "DecimalFiltering", _DecimalFiltering_decorators, _DecimalFiltering);
__name(_DecimalFiltering, "DecimalFiltering");
__runInitializers(_init98, 1, _DecimalFiltering);
var DecimalFiltering = _DecimalFiltering;
var _EditorFiltering_decorators, _init99, _a48;
_EditorFiltering_decorators = [Filtering("Editor")];
var _EditorFiltering = class _EditorFiltering extends (_a48 = BaseEditorFiltering) {
  constructor(props = {}) {
    var _a68;
    super(Widget);
    this.props = props;
  ...
  createEditor() {
    if (this.useEditor()) {
      ...
      this.editor = new editorType(__spreadValues({
        element: /* @__PURE__ */ __name((el) => this.get_container().append(el), "element")
...
_EditorFiltering = __decorateElement(_init99, 0, "EditorFiltering", _EditorFiltering_decorators, _EditorFiltering);
__name(_EditorFiltering, "EditorFiltering");
__runInitializers(_init99, 1, _EditorFiltering);
var EditorFiltering = _EditorFiltering;
var _EnumFiltering_decorators, _init100, _a49;
_EnumFiltering_decorators = [Filtering("Enum")];
var _EnumFiltering = class _EnumFiltering extends (_a49 = BaseEditorFiltering) {
  constructor() {
    super(EnumEditor);
  }
  getOperators() {
...
_EnumFiltering = __decorateElement(_init100, 0, "EnumFiltering", _EnumFiltering_decorators, _EnumFiltering);
__name(_EnumFiltering, "EnumFiltering");
__runInitializers(_init100, 1, _EnumFiltering);
var EnumFiltering = _EnumFiltering;
var _IntegerFiltering_decorators, _init101, _a50;
_IntegerFiltering_decorators = [Filtering("Integer")];
var _IntegerFiltering = class _IntegerFiltering extends (_a50 = BaseEditorFiltering) {
  constructor() {
    super(IntegerEditor);
  }
  getOperators() {
...
_IntegerFiltering = __decorateElement(_init101, 0, "IntegerFiltering", _IntegerFiltering_decorators, _IntegerFiltering);
__name(_IntegerFiltering, "IntegerFiltering");
__runInitializers(_init101, 1, _IntegerFiltering);
var IntegerFiltering = _IntegerFiltering;
var _LookupFiltering_decorators, _init102, _a51;
_LookupFiltering_decorators = [Filtering("Lookup")];
var _LookupFiltering = class _LookupFiltering extends (_a51 = BaseEditorFiltering) {
  constructor() {
    super(LookupEditor);
  }
  getOperators() {
...
_LookupFiltering = __decorateElement(_init102, 0, "LookupFiltering", _LookupFiltering_decorators, _LookupFiltering);
__name(_LookupFiltering, "LookupFiltering");
__runInitializers(_init102, 1, _LookupFiltering);
var LookupFiltering = _LookupFiltering;
var _ServiceLookupFiltering_decorators, _init103, _a52;
_ServiceLookupFiltering_decorators = [Filtering("ServiceLookup")];
var _ServiceLookupFiltering = class _ServiceLookupFiltering extends (_a52 = BaseEditorFiltering) {
  constructor() {
...
_ServiceLookupFiltering = __decorateElement(_init103, 0, "ServiceLookupFiltering", _ServiceLookupFiltering_decorators, _ServiceLookupFiltering);
__name(_ServiceLookupFiltering, "ServiceLookupFiltering");
__runInitializers(_init103, 1, _ServiceLookupFiltering);
var ServiceLookupFiltering = _ServiceLookupFiltering;
var _StringFiltering_decorators, _init104, _a53;
_StringFiltering_decorators = [Filtering("String")];
var _StringFiltering = class _StringFiltering extends (_a53 = BaseFiltering) {
  getOperators() {
    var ops = [
...
_StringFiltering = __decorateElement(_init104, 0, "StringFiltering", _StringFiltering_decorators, _StringFiltering);
__name(_StringFiltering, "StringFiltering");
__runInitializers(_init104, 1, _StringFiltering);
var StringFiltering = _StringFiltering;
...
((FilteringTypeRegistry2) => {
  ...
  __name(setTypeKeysWithoutFilterHandlerSuffix, "setTypeKeysWithoutFilterHandlerSuffix");
  function reset() {
    knownTypes = null;
  }
...
var _FilterWidgetBase = class _FilterWidgetBase extends (_a54 = Widget) {
  constructor(props) {
    super(props);
...
_FilterWidgetBase = __decorateElement(_init105, 0, "FilterWidgetBase", _FilterWidgetBase_decorators, _FilterWidgetBase);
__name(_FilterWidgetBase, "FilterWidgetBase");
__runInitializers(_init105, 1, _FilterWidgetBase);
var FilterWidgetBase = _FilterWidgetBase;

// src/ui/filtering/filterpanel.tsx
...
var _FilterFieldSelect = class _FilterFieldSelect extends (_a55 = ComboboxEditor) {
  constructor(props) {
    var _a68, _b;
    super(props);
...
_FilterFieldSelect = __decorateElement(_init106, 0, "FilterFieldSelect", _FilterFieldSelect_decorators, _FilterFieldSelect);
__name(_FilterFieldSelect, "FilterFieldSelect");
__runInitializers(_init106, 1, _FilterFieldSelect);
var FilterFieldSelect = _FilterFieldSelect;
...
var _FilterOperatorSelect = class _FilterOperatorSelect extends (_a56 = ComboboxEditor) {
  constructor(props) {
    var _a68, _b;
    super(props);
...
_FilterOperatorSelect = __decorateElement(_init107, 0, "FilterOperatorSelect", _FilterOperatorSelect_decorators, _FilterOperatorSelect);
__name(_FilterOperatorSelect, "FilterOperatorSelect");
__runInitializers(_init107, 1, _FilterOperatorSelect);
var FilterOperatorSelect = _FilterOperatorSelect;
var _FilterPanel_decorators, _init108, _a57;
_FilterPanel_decorators = [Decorators.registerClass("Serenity.FilterPanel")];
var _FilterPanel = class _FilterPanel extends (_a57 = FilterWidgetBase) {
  constructor(props) {
    super(props);
  ...
  renderContents() {
    ...
    return /* @__PURE__ */ jsx(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { id: id.Rows, class: "filter-lines" }),
      /* @__PURE__ */ jsx("div", { id: id.Buttons, class: "buttons", children: [
        /* @__PURE__ */ jsx("button", { id: id.AddButton, type: "button", class: "btn btn-primary add", onClick: (e) => this.addButtonClick(e), children: localText("Controls.FilterPanel.AddFilter") }),
        /* @__PURE__ */ jsx("button", { id: id.SearchButton, type: "button", class: "btn btn-success search", onClick: (e) => this.searchButtonClick(e), ref: (el) => this.searchButton = el, children: localText("Controls.FilterPanel.SearchButton") }),
        /* @__PURE__ */ jsx("button", { id: id.ResetButton, type: "button", class: "btn btn-danger reset", onClick: (e) => this.resetButtonClick(e), ref: (el) => this.resetButton = el, children: localText("Controls.FilterPanel.ResetButton") })
      ] }),
  ...
  search() {
    ...
    if (errorText != null) {
      row.querySelector("div.v").appendChild(/* @__PURE__ */ jsx("span", { class: "error", title: errorText }));
  ...
  populateOperatorList(row) {
    ...
    if (filtering == null)
      return;
    const hidden = opDiv.appendChild(/* @__PURE__ */ jsx("input", { type: "hidden", class: "op-select" }));
...
_FilterPanel = __decorateElement(_init108, 0, "FilterPanel", _FilterPanel_decorators, _FilterPanel);
__name(_FilterPanel, "FilterPanel");
__runInitializers(_init108, 1, _FilterPanel);
var FilterPanel = _FilterPanel;

// src/ui/filtering/filterdialog.tsx
var _FilterDialog_decorators, _init109, _a58;
_FilterDialog_decorators = [Decorators.registerClass("Serenity.FilterDialog")];
var _FilterDialog = class _FilterDialog extends (_a58 = BaseDialog) {
  constructor(props) {
    super(props);
  ...
  renderContents() {
    return /* @__PURE__ */ jsx("div", { id: this.useIdPrefix().FilterPanel });
  }
  getDialogOptions() {
    var opt = super.getDialogOptions();
...
_FilterDialog = __decorateElement(_init109, 0, "FilterDialog", _FilterDialog_decorators, _FilterDialog);
__name(_FilterDialog, "FilterDialog");
__runInitializers(_init109, 1, _FilterDialog);
var FilterDialog = _FilterDialog;

// src/ui/filtering/filterdisplaybar.tsx
...
var _FilterDisplayBar = class _FilterDisplayBar extends (_a59 = FilterWidgetBase) {
  renderContents() {
    var openFilterDialog = /* @__PURE__ */ __name((e) => {
      e.preventDefault();
    ...
    return /* @__PURE__ */ jsx("div", { children: [
      /* @__PURE__ */ jsx("a", { class: "reset", title: localText("Controls.FilterPanel.ResetFilterHint"), onClick: (e) => {
        e.preventDefault();
        this.get_store().get_items().length = 0;
        this.get_store().raiseChanged();
      } }),
      /* @__PURE__ */ jsx("a", { class: "edit", onClick: openFilterDialog, children: localText("Controls.FilterPanel.EditFilter") }),
      /* @__PURE__ */ jsx("div", { class: "current", children: [
        /* @__PURE__ */ jsx("span", { class: "cap", children: localText("Controls.FilterPanel.EffectiveFilter") }),
        /* @__PURE__ */ jsx("a", { class: "txt", onClick: openFilterDialog })
      ] })
    ] });
  }
  filterStoreChanged() {
...
_FilterDisplayBar = __decorateElement(_init110, 0, "FilterDisplayBar", _FilterDisplayBar_decorators, _FilterDisplayBar);
__name(_FilterDisplayBar, "FilterDisplayBar");
__runInitializers(_init110, 1, _FilterDisplayBar);
var FilterDisplayBar = _FilterDisplayBar;

// src/ui/datagrid/slickpager.tsx
var _SlickPager_decorators, _init111, _a60;
_SlickPager_decorators = [Decorators.registerClass("Serenity.SlickPager")];
var _SlickPager = class _SlickPager extends (_a60 = Widget) {
  constructor(props) {
    var _a68, _b;
    super(props);
    ...
    const p = "slick-pg-";
    const Group2 = /* @__PURE__ */ __name(({ id, children }) => /* @__PURE__ */ jsx("div", { class: `${p}grp ${p}grp-${id}`, children }), "Group");
    const Button = /* @__PURE__ */ __name(({ id, onClick }) => /* @__PURE__ */ jsx("div", { class: `${p}${id} ${p}btn`, onClick, children: /* @__PURE__ */ jsx("span", { class: `${p}btn-span` }) }), "Button");
    const NavButton = /* @__PURE__ */ __name(({ id, onClick }) => {
      const b = Button({ id, onClick });
      Fluent.on(b, "click", () => this._changePage(id));
      return b;
    }, "NavButton");
    this.element.addClass("s-SlickPager slick-pg").append(
      /* @__PURE__ */ jsx("div", { class: p + "in", children: [
        opt.showRowsPerPage && /* @__PURE__ */ jsx(Group2, { id: "size", children: this.pageSize = /* @__PURE__ */ jsx("select", { class: `${p}size`, name: "rp", onChange: () => {
        ...
        }, children: opt.rowsPerPageOptions.map((rowsPerPage) => /* @__PURE__ */ jsx("option", { value: rowsPerPage, selected: v.rowsPerPage == rowsPerPage, children: rowsPerPage })) }) }),
        /* @__PURE__ */ jsx(Group2, { id: "firstprev", children: [
          /* @__PURE__ */ jsx(NavButton, { id: "first" }),
          /* @__PURE__ */ jsx(NavButton, { id: "prev" })
        ] }),
        /* @__PURE__ */ jsx(Group2, { id: "control", children: /* @__PURE__ */ jsx("span", { class: `${p}control`, children: [
          /* @__PURE__ */ jsx("span", { class: `${p}pagetext`, children: localText("Controls.Pager.Page") }),
          this.currentPage = /* @__PURE__ */ jsx("input", { class: `${p}current mx-1`, type: "text", size: 4, value: "1", onKeyDown: (e) => {
            if (e.key === "Enter") this._changePage("input");
          } }),
          /* @__PURE__ */ jsx("span", { class: `${p}pagesep px-1`, children: "/" }),
          this.totalPages = /* @__PURE__ */ jsx("span", { class: `${p}total`, children: "1" })
        ] }) }),
        /* @__PURE__ */ jsx(Group2, { id: "nextlast", children: [
          /* @__PURE__ */ jsx(NavButton, { id: "next" }),
          /* @__PURE__ */ jsx(NavButton, { id: "last" })
        ] }),
        /* @__PURE__ */ jsx(Group2, { id: "reload", children: /* @__PURE__ */ jsx(Button, { id: "reload", onClick: () => v.populate() }) }),
        /* @__PURE__ */ jsx(Group2, { id: "stat", children: this.stat = /* @__PURE__ */ jsx("span", { class: `${p}stat` }) })
      ] })
    );
  ...
  _updatePager() {
    ...
    var info = view.getPagingInfo();
    var pages = !info.rowsPerPage || !info.totalCount ? 1 : Math.ceil(info.totalCount / info.rowsPerPage);
    this.currentPage.value = (_a68 = info.page) == null ? void 0 : _a68.toString();
...
_SlickPager = __decorateElement(_init111, 0, "SlickPager", _SlickPager_decorators, _SlickPager);
__name(_SlickPager, "SlickPager");
__runInitializers(_init111, 1, _SlickPager);
var SlickPager = _SlickPager;

// src/ui/helpers/slickhelpers.tsx
...
var _IInitializeColumn = class _IInitializeColumn {
};
_init112 = __decoratorStart(null);
_IInitializeColumn = __decorateElement(_init112, 0, "IInitializeColumn", _IInitializeColumn_decorators, _IInitializeColumn);
__name(_IInitializeColumn, "IInitializeColumn");
__runInitializers(_init112, 1, _IInitializeColumn);
var IInitializeColumn = _IInitializeColumn;
...
var _BooleanFormatter = class _BooleanFormatter {
  constructor(props = {}) {
    this.props = props;
    var _a68;
    (_a68 = this.props) != null ? _a68 : this.props = {};
...
_BooleanFormatter = __decorateElement(_init113, 0, "BooleanFormatter", _BooleanFormatter_decorators, _BooleanFormatter);
__name(_BooleanFormatter, "BooleanFormatter");
__runInitializers(_init113, 1, _BooleanFormatter);
...
var _CheckboxFormatter = class _CheckboxFormatter {
  format(ctx) {
    return '<span class="check-box no-float readonly slick-edit-preclick ' + (!!ctx.value ? " checked" : "") + '"></span>';
  }
};
_init114 = __decoratorStart(null);
_CheckboxFormatter = __decorateElement(_init114, 0, "CheckboxFormatter", _CheckboxFormatter_decorators, _CheckboxFormatter);
__name(_CheckboxFormatter, "CheckboxFormatter");
_CheckboxFormatter.typeInfo = Decorators.formatterType("Serenity.CheckboxFormatter");
__runInitializers(_init114, 1, _CheckboxFormatter);
var CheckboxFormatter = _CheckboxFormatter;
...
var _DateTimeFormatter = class _DateTimeFormatter extends (_a61 = DateFormatter) {
  constructor(props = {}) {
    super(__spreadValues({ displayFormat: Culture.dateTimeFormat }, props));
  }
};
_init116 = __decoratorStart(_a61);
_DateTimeFormatter = __decorateElement(_init116, 0, "DateTimeFormatter", _DateTimeFormatter_decorators, _DateTimeFormatter);
__name(_DateTimeFormatter, "DateTimeFormatter");
__runInitializers(_init116, 1, _DateTimeFormatter);
...
__name(_EnumFormatter, "EnumFormatter");
...
__name(_FileDownloadFormatter, "FileDownloadFormatter");
...
__name(_MinuteFormatter, "MinuteFormatter");
...
__name(_NumberFormatter, "NumberFormatter");
...
var _UrlFormatter = class _UrlFormatter {
  constructor(props = {}) {
    this.props = props;
    var _a68;
    (_a68 = this.props) != null ? _a68 : this.props = {};
...
_UrlFormatter = __decorateElement(_init121, 0, "UrlFormatter", _UrlFormatter_decorators, _UrlFormatter);
__name(_UrlFormatter, "UrlFormatter");
__runInitializers(_init121, 1, _UrlFormatter);
var UrlFormatter = _UrlFormatter;
...
var _GridRowSelectionMixin = class _GridRowSelectionMixin {
  ...
  updateSelectAll() {
    ...
    if (selectAllButton) {
      var keys2 = Object.keys(this.include);
      selectAllButton.classList.toggle(
        "checked",
        keys2.length > 0 && this.grid.getView().getItems().filter(
  ...
  static createSelectColumn(getMixin) {
    return {
      ...
      sortable: false,
      format: /* @__PURE__ */ __name(function(ctx) {
        var item = ctx.item;
        var mixin = getMixin();
...
_GridRowSelectionMixin = __decorateElement(_init122, 0, "GridRowSelectionMixin", _GridRowSelectionMixin_decorators, _GridRowSelectionMixin);
__name(_GridRowSelectionMixin, "GridRowSelectionMixin");
__runInitializers(_init122, 1, _GridRowSelectionMixin);
var GridRowSelectionMixin = _GridRowSelectionMixin;
...
var _GridRadioSelectionMixin = class _GridRadioSelectionMixin {
  constructor(grid, options) {
    this.include = {};
    this.grid = grid;
    this.idField = grid.getView().idField;
  ...
  static createSelectColumn(getMixin) {
    return {
      ...
      headerCssClass: "",
      sortable: false,
      formatter: /* @__PURE__ */ __name(function(row, cell, value, column, item) {
        var mixin = getMixin();
        if (!mixin || !mixin.isSelectable(item)) {
          return "";
        }
...
_GridRadioSelectionMixin = __decorateElement(_init123, 0, "GridRadioSelectionMixin", _GridRadioSelectionMixin_decorators, _GridRadioSelectionMixin);
__name(_GridRadioSelectionMixin, "GridRadioSelectionMixin");
__runInitializers(_init123, 1, _GridRadioSelectionMixin);
var GridRadioSelectionMixin = _GridRadioSelectionMixin;
...
((GridUtils2) => {
  function addToggleButton(toolDiv, cssClass, callback, hint, initial) {
    const btn = /* @__PURE__ */ jsx("div", { class: ["s-ToggleButton", cssClass, initial && "pressed"], children: /* @__PURE__ */ jsx("a", { href: "#", title: hint != null ? hint : "", onClick: (e) => {
      e.preventDefault();
  ...
  __name(addToggleButton, "addToggleButton");
  ...
  __name(addIncludeDeletedToggle, "addIncludeDeletedToggle");
  ...
  __name(addQuickSearchInput, "addQuickSearchInput");
  function addQuickSearchInputCustom(container, onSearch, fields) {
    const input = /* @__PURE__ */ jsx("input", { type: "text" });
    (isArrayLike(container) ? container[0] : container).prepend(/* @__PURE__ */ jsx("div", { class: ["s-QuickSearchBar", (fields == null ? void 0 : fields.length) && "has-quick-search-files"], children: input }));
  ...
  __name(addQuickSearchInputCustom, "addQuickSearchInputCustom");
  ...
  __name(makeOrderable, "makeOrderable");
  ...
  __name(makeOrderableWithUpdateRequest, "makeOrderableWithUpdateRequest");
})(GridUtils || (GridUtils = {}));
...
((PropertyItemSlickConverter2) => {
  ...
  __name(toSlickColumns, "toSlickColumns");
  function toSlickColumn(item) {
    ...
    const then = /* @__PURE__ */ __name((formatterType2) => {
      var _a69;
  ...
  __name(toSlickColumn, "toSlickColumn");
...
((SlickFormatting2) => {
  ...
  __name(getEnumText, "getEnumText");
  function treeToggle(getView, getId, formatter) {
    return function(ctx) {
      var _a68, _b;
      const text2 = formatter(ctx);
      const view = getView();
      const indent = (_a68 = ctx.item._indent) != null ? _a68 : 0;
      const spacer = /* @__PURE__ */ jsx("span", { class: "s-TreeIndent", style: { width: 15 * indent + "px" } });
      const toggle = /* @__PURE__ */ jsx("span", { class: "s-TreeToggle" });
      ...
      if (text2 instanceof Element) {
        ...
        text2.prepend(toggle);
        text2.prepend(spacer);
        return text2;
      } else
        return spacer.outerHTML + toggle.outerHTML + (text2 != null ? text2 : "");
    };
  }
  SlickFormatting2.treeToggle = treeToggle;
  __name(treeToggle, "treeToggle");
  ...
  __name(itemLinkText, "itemLinkText");
...
((SlickTreeHelper2) => {
  ...
  __name(filterCustom, "filterCustom");
  ...
  __name(toggleClick, "toggleClick");
})(SlickTreeHelper || (SlickTreeHelper = {}));
var _ColumnsBase = class _ColumnsBase {
  constructor(items) {
    var _a68;
    this.__items = items;
...
__name(_ColumnsBase, "ColumnsBase");
var ColumnsBase = _ColumnsBase;

// src/ui/datagrid/datagrid.tsx
...
var _DataGrid = class _DataGrid extends (_a62 = Widget) {
  ...
  createQuickFilters(filters) {
    if (this.quickFiltersDiv == null && (filters != null || (filters = this.getQuickFilters()) && filters != null && filters.length)) {
      this.quickFiltersDiv = Fluent(/* @__PURE__ */ jsx("div", { class: "quick-filters-bar" }));
      if (this.toolbar) {
        this.toolbar.domNode.append(/* @__PURE__ */ jsx("div", { class: "clear" }), this.quickFiltersDiv.getNode());
      } else {
        this.quickFiltersDiv.appendTo(Fluent(/* @__PURE__ */ jsx("div", { class: "s-Toolbar" })).insertBefore(this.slickContainer));
      }
      this.quickFiltersBar = new QuickFilterBar({
        filters,
        getTitle: /* @__PURE__ */ __name((filter) => this.determineText((pre) => pre + filter.field), "getTitle"),
  ...
  createSlickContainer() {
    return Fluent(/* @__PURE__ */ jsx("div", { class: "grid-container" })).appendTo(this.domNode);
  }
  createView() {
  ...
  createPager() {
    new SlickPager(__spreadProps(__spreadValues({}, this.getPagerOptions()), { element: /* @__PURE__ */ __name((el) => this.domNode.append(el), "element") }));
  }
  getViewOptions() {
    var opt = {};
  ...
  createToolbar(buttons) {
    this.toolbar = new Toolbar({
      ...
      element: /* @__PURE__ */ __name((el) => this.domNode.appendChild(el).classList.add("grid-toolbar"), "element")
    }).init();
  }
  getTitle() {
    if (!this.titleDiv) {
  ...
  setTitle(value) {
    if (value !== this.getTitle()) {
      if (value == null) {
        ...
        if (!this.titleDiv) {
          this.titleDiv = Fluent(/* @__PURE__ */ jsx("div", { class: "grid-title", children: /* @__PURE__ */ jsx("div", { class: "title-text" }) })).prependTo(this.domNode);
        }
  ...
  getIdProperty() {
    ...
    var attr3 = this.getCustomAttribute(IdPropertyAttribute);
    if (attr3)
      return this._idProperty = (_b = attr3.value) != null ? _b : "";
  ...
  getIsActiveProperty() {
    ...
    var attr3 = this.getCustomAttribute(IsActivePropertyAttribute);
    if (attr3)
      return this._isActiveProperty = (_b = attr3.value) != null ? _b : "";
    return this._isActiveProperty = "";
  }
  updateDisabledState() {
  ...
  restoreSettingsFrom(settings, flags) {
    ...
    var columns = this.slickGrid.getColumns();
    var colById = null;
    var updateColById = /* @__PURE__ */ __name(function(cl) {
      colById = {};
...
__name(_DataGrid, "DataGrid");
__runInitializers(_init124, 1, _DataGrid);
var DataGrid = _DataGrid;

// src/ui/datagrid/columnpickerdialog.tsx
...
var _ColumnPickerDialog = class _ColumnPickerDialog extends (_a63 = BaseDialog) {
  renderContents() {
    ...
    return /* @__PURE__ */ jsx("div", { class: "columns-container", children: [
      /* @__PURE__ */ jsx("div", { class: "column-list visible-list bg-success", children: [
        /* @__PURE__ */ jsx("h5", { children: [
          /* @__PURE__ */ jsx("i", { class: faIcon("eye") }),
          " ",
          localText(localText("Controls.ColumnPickerDialog.VisibleColumns"))
        ] }),
        /* @__PURE__ */ jsx("ul", { ref: (ref) => this.ulVisible = ref })
      ] }),
      /* @__PURE__ */ jsx("div", { class: "column-list hidden-list bg-info", children: [
        /* @__PURE__ */ jsx("h5", { children: [
          /* @__PURE__ */ jsx("i", { class: faIcon("eye-slash") }),
          " ",
          localText(localText("Controls.ColumnPickerDialog.HiddenColumns"))
        ] }),
        /* @__PURE__ */ jsx("ul", { ref: (ref) => this.ulHidden = ref })
      ] })
    ] });
  }
    ...
    return [
      {
        ...
        click: /* @__PURE__ */ __name(() => {
          let liByKey = {};
          Array.from(this.ulVisible.childNodes).concat(Array.from(this.ulHidden.childNodes)).forEach((el) => {
      ...
      okDialogButton({
        click: /* @__PURE__ */ __name(() => {
          ...
          for (var col of this.allColumns)
            col.visible = false;
          this.visibleColumns = Array.from(this.ulVisible.childNodes).map((x) => {
  ...
  createLI(col) {
    ...
    return /* @__PURE__ */ jsx("li", { class: !allowHide && "cant-hide", "data-key": col.id, children: [
      /* @__PURE__ */ jsx("span", { class: "drag-handle", children: "\u2630" }),
      this.getTitle(col),
      allowHide && /* @__PURE__ */ jsx("i", { class: ["js-hide", faIcon("eye-slash")], title: localText("Controls.ColumnPickerDialog.HideHint") }),
      /* @__PURE__ */ jsx("i", { class: ["js-show", faIcon("eye")], title: localText("Controls.ColumnPickerDialog.ShowHint") })
    ] });
  }
  updateListStates() {
    this.ulVisible.childNodes.forEach((x) => {
      x.classList.remove("bg-info");
      x.classList.add("bg-success");
    });
    this.ulHidden.childNodes.forEach((x) => {
  ...
  setupColumns() {
    ...
    if (typeof Sortable !== "undefined" && Sortable.create) {
      Sortable.create(this.ulVisible, {
        ...
        filter: ".js-hide",
        onFilter: /* @__PURE__ */ __name((evt) => {
          this.ulHidden.append(evt.item);
          this.updateListStates();
        }, "onFilter"),
        onMove: /* @__PURE__ */ __name((x) => {
          if (x.dragged.classList.contains("cant-hide") && x.from == this.ulVisible && x.to !== x.from)
            return false;
          return true;
        }, "onMove"),
        onEnd: /* @__PURE__ */ __name((evt) => this.updateListStates(), "onEnd")
      });
      Sortable.create(this.ulHidden, {
        ...
        onEnd: /* @__PURE__ */ __name(() => this.updateListStates(), "onEnd")
      });
    }
  }
  onDialogOpen() {
...
__name(_ColumnPickerDialog, "ColumnPickerDialog");
...
var _TreeGridMixin = class _TreeGridMixin {
  constructor(options) {
    this.options = options;
    var _a68;
    var dg = this.dataGrid = options.grid;
    var idProperty = dg.getIdProperty();
    var getId = /* @__PURE__ */ __name((item) => item[idProperty], "getId");
...
__name(_TreeGridMixin, "TreeGridMixin");
var TreeGridMixin = _TreeGridMixin;
...
var _CheckTreeEditor = class _CheckTreeEditor extends (_a64 = DataGrid) {
  static createDefaultElement() {
    return document.createElement("div");
  }
  constructor(props) {
...
_CheckTreeEditor = __decorateElement(_init126, 0, "CheckTreeEditor", _CheckTreeEditor_decorators, _CheckTreeEditor);
__name(_CheckTreeEditor, "CheckTreeEditor");
__runInitializers(_init126, 1, _CheckTreeEditor);
var CheckTreeEditor = _CheckTreeEditor;
...
var _CheckLookupEditor = class _CheckLookupEditor extends (_a65 = CheckTreeEditor) {
  constructor(props) {
    super(props);
...
_CheckLookupEditor = __decorateElement(_init127, 0, "CheckLookupEditor", _CheckLookupEditor_decorators, _CheckLookupEditor);
__name(_CheckLookupEditor, "CheckLookupEditor");
__runInitializers(_init127, 1, _CheckLookupEditor);
var CheckLookupEditor = _CheckLookupEditor;
...
var _EntityGrid = class _EntityGrid extends (_a66 = DataGrid) {
  constructor(props) {
    super(props);
  ...
  getEntityType() {
    ...
    var attr3 = this.getCustomAttribute(EntityTypeAttribute);
    if (attr3) {
      return this._entityType = attr3.value;
    }
    var name = getTypeFullName(getInstanceType(this));
    var px = name.indexOf(".");
    if (px >= 0) {
  ...
  getDisplayName() {
    ...
    var attr3 = this.getCustomAttribute(DisplayNameAttribute);
    if (attr3) {
      this._displayName = attr3.displayName;
  ...
  getItemName() {
    ...
    var attr3 = this.getCustomAttribute(ItemNameAttribute);
    if (attr3) {
      this._itemName = attr3.value;
  ...
  getButtons() {
    ...
    buttons.push({
      ...
      disabled: /* @__PURE__ */ __name(() => !this.hasInsertPermission() || this.readOnly, "disabled")
    });
  ...
  getService() {
    ...
    var attr3 = this.getCustomAttribute(ServiceAttribute);
    if (attr3)
      this._service = attr3.value;
    else
  ...
  getDialogType() {
    ...
    var attr3 = this.getCustomAttribute(DialogTypeAttribute);
    if (attr3)
      this._dialogType = attr3.value;
    else {
...
_EntityGrid = __decorateElement(_init128, 0, "EntityGrid", _EntityGrid_decorators, _EntityGrid);
__name(_EntityGrid, "EntityGrid");
__runInitializers(_init128, 1, _EntityGrid);
var EntityGrid = _EntityGrid;

// src/ui/dialogs/entitytoolbuttons.tsx
function saveAndCloseToolButton(opt) {
...
__name(saveAndCloseToolButton, "saveAndCloseToolButton");
function applyChangesToolButton(opt) {
  return __spreadValues({
    title: "",
...
__name(applyChangesToolButton, "applyChangesToolButton");
function deleteToolButton(opt) {
  return __spreadValues({
...
__name(deleteToolButton, "deleteToolButton");
function undeleteToolButton(opt) {
  return __spreadValues({
...
__name(undeleteToolButton, "undeleteToolButton");
function editToolButton(opt) {
  return __spreadValues({
...
__name(editToolButton, "editToolButton");
function localizationToolButton(opt) {
  return __spreadValues({
...
__name(localizationToolButton, "localizationToolButton");
function cloneToolButton(opt) {
  return __spreadValues({
...
__name(cloneToolButton, "cloneToolButton");

// src/ui/dialogs/entitylocalizer.tsx
var _EntityLocalizer = class _EntityLocalizer {
  constructor(opt) {
    var _a68;
    this.options = opt;
    const { pgOptions, idPrefix } = opt;
    const pgDiv = this.options.getPropertyGrid();
    if (!(pgDiv == null ? void 0 : pgDiv.getNode()) || !pgOptions.items.some((x) => x.localizable === true))
      return;
    const localGridDiv = /* @__PURE__ */ jsx("div", { id: idPrefix + "LocalizationGrid", style: "display: none" });
    pgDiv.after(localGridDiv);
    const langs = this.options.getLanguages() || [];
    this.targetLanguage = /* @__PURE__ */ jsx("select", { class: "target-language ms-2", style: "display: none", children: [
      /* @__PURE__ */ jsx("option", { value: "", children: [
        "--",
        localText("Site.Translation.TargetLanguage"),
        "--"
      ] }),
      langs.map((x) => /* @__PURE__ */ jsx("option", { value: x.id, children: x.text }))
    ] });
    (_a68 = this.options.getButton()) == null ? void 0 : _a68.after(this.targetLanguage);
    ...
    this.grid = new PropertyGrid(__spreadValues({ element: localGridDiv }, pgOptions)).init();
    localGridDiv.classList.add("s-LocalizationGrid");
    if (TranslationConfig.translateTexts) {
      this.grid.element.findAll("input[type=text].editor").forEach((input) => {
        if (!input.name || input.name.indexOf("$") < 0)
          return;
        const div = /* @__PURE__ */ jsx("div", { class: "input-group w-100" });
        Fluent(div).insertBefore(input);
        input.classList.add("form-control");
        div.append(input);
        div.append(
          /* @__PURE__ */ jsx("button", { class: "btn btn-primary btn-sm", title: localText("Site.Translation.TranslateText"), onClick: () => {
          ...
          }, children: /* @__PURE__ */ jsx("span", { class: faIcon("language") }) })
        );
      });
    }
    const targetLanguageUpdate = /* @__PURE__ */ __name(() => {
      var _a69;
      const val = (_a69 = this.targetLanguage) == null ? void 0 : _a69.value;
      this.grid.element.findAll(".translation").forEach((x) => {
        var _a70;
        return (_a70 = x.closest(".field")) == null ? void 0 : _a70.classList.toggle("hidden", !!val && !x.classList.contains("language-" + val));
      });
    ...
    Fluent.on(this.targetLanguage, "change", () => {
      var _a69;
      targetLanguageUpdate();
      localStorage.setItem("EntityLocalizer.TargetLanguage", (_a69 = this.targetLanguage) == null ? void 0 : _a69.value);
    });
  }
  destroy() {
    if (this.grid) {
  ...
  isLocalizationMode() {
    var _a68;
    return !!(this.isEnabled() && ((_a68 = this.options.getButton()) == null ? void 0 : _a68.hasClass("pressed")));
  }
  ...
  buttonClick() {
    ...
    (_a68 = this.options.getButton()) == null ? void 0 : _a68.toggleClass("pressed");
    this.updateInterface();
    if (this.isLocalizationMode()) {
  ...
  loadLocalization() {
    ...
    this.options.retrieveLocalizations().then((localizations) => {
      ...
      Object.entries(localizations != null ? localizations : {}).forEach(([language, entity]) => Object.entries(entity != null ? entity : {}).forEach(([field, value]) => copy[language + "$" + field] = value));
      this.grid.load(copy);
      this.setLocalizationGridCurrentValues();
      this.pendingValue = null;
      this.lastValue = this.getLocalizationGridValue();
  ...
  updateInterface() {
    ...
    if (!this.isEnabled())
      return;
    const button = (_a68 = this.options.getButton()) == null ? void 0 : _a68.getNode();
    const locMode = this.isLocalizationMode();
    Fluent.toggle(this.targetLanguage, locMode);
    const inner = button == null ? void 0 : button.querySelector(".button-inner");
    inner && (inner.textContent = locMode ? localText("Controls.EntityDialog.LocalizationBack") : localText("Controls.EntityDialog.LocalizationButton"));
    (_b = this.options.getPropertyGrid()) == null ? void 0 : _b.toggle(!locMode);
    Fluent.toggle((_c = this.grid) == null ? void 0 : _c.domNode, locMode);
    Fluent.toggle(this.targetLanguage, locMode);
    const buttons = this.options.getToolButtons().filter((x) => x !== button);
    if (locMode) {
      buttons == null ? void 0 : buttons.filter((x) => !x.classList.contains("localization-hidden")).forEach((el) => {
...
__name(_EntityLocalizer, "EntityLocalizer");
var EntityLocalizer = _EntityLocalizer;

// src/ui/dialogs/entitydialog.tsx
...
var _EntityDialog = class _EntityDialog extends (_a67 = BaseDialog) {
  ...
  destroy() {
    var _a68, _b;
    (_a68 = this.propertyGrid) == null ? void 0 : _a68.destroy();
    delete this.propertyGrid;
    (_b = this.localizer) == null ? void 0 : _b.destroy();
    delete this.localizer;
    delete this.toolbar;
    Object.keys(this).filter((k) => Object.prototype.hasOwnProperty.call(this, k) && k.endsWith("Button")).forEach((k) => delete this[k]);
    super.destroy();
  }
  get entity() {
    return this._entity;
  ...
  getEntityTitle() {
    ...
    const titleFormat = this.isViewMode() || this.readOnly || !this.hasSavePermission() ? localText("Controls.EntityDialog.ViewRecordTitle") : localText("Controls.EntityDialog.EditRecordTitle");
    const title = (_a68 = this.getEntityNameFieldValue()) != null ? _a68 : "";
  ...
  isDeleted() {
    ...
    const value = this.entity[this.getIsActiveProperty()];
    if (value == null)
      return false;
    return value < 0;
  }
  ...
  getEntityType() {
    if (this._entityType != null)
      return this._entityType;
    const attr3 = this.getCustomAttribute(EntityTypeAttribute);
    if (attr3)
      return this._entityType = attr3.value;
  ...
  getFormKey() {
    ...
    const attr3 = this.getCustomAttribute(FormKeyAttribute);
    return this._formKey = attr3 ? attr3.value : this.getEntityType();
  }
  getLocalTextDbPrefix() {
    var _a68;
    if (this._localTextDbPrefix != null)
  ...
  getLocalTextPrefix() {
    ...
    if (rowDefinition)
      return rowDefinition.localTextPrefix;
    const attr3 = this.getCustomAttribute(LocalTextPrefixAttribute);
    return attr3 ? attr3.value : this.getEntityType();
  }
  getEntitySingular() {
    var _a68;
    if (this._entitySingular != null)
      return this._entitySingular;
    const attr3 = this.getCustomAttribute(ItemNameAttribute);
    return this._entitySingular = attr3 ? localText(attr3.value, attr3.value) : (_a68 = tryGetText(this.getLocalTextDbPrefix() + "EntitySingular")) != null ? _a68 : this.getEntityType();
  }
  getNameProperty() {
    var _a68, _b;
    ...
    const attr3 = this.getCustomAttribute(NamePropertyAttribute);
    return this._nameProperty = attr3 ? (_b = attr3.value) != null ? _b : "" : "Name";
  }
  getIdProperty() {
    var _a68, _b;
    if (this._idProperty != null)
    ...
    if (rowDefinition)
      return this._idProperty = (_a68 = rowDefinition.idProperty) != null ? _a68 : "";
    const attr3 = this.getCustomAttribute(IdPropertyAttribute);
    return this._idProperty = attr3 ? (_b = attr3.value) != null ? _b : "" : "ID";
  }
  getIsActiveProperty() {
    var _a68, _b, _c;
    if (this._isActiveProperty != null)
      return this._isActiveProperty;
    const rowDefinition = this.getRowDefinition();
    return this._isActiveProperty = rowDefinition ? (_a68 = rowDefinition.isActiveProperty) != null ? _a68 : "" : (_c = (_b = this.getCustomAttribute(IsActivePropertyAttribute)) == null ? void 0 : _b.value) != null ? _c : "";
  }
  getIsDeletedProperty() {
    var _a68;
    return (_a68 = this.getRowDefinition()) == null ? void 0 : _a68.isDeletedProperty;
  ...
  getService() {
    if (this._service != null)
      return this._service;
    const attr3 = this.getCustomAttribute(ServiceAttribute);
    return this._service = attr3 ? attr3.value : replaceAll(this.getEntityType(), ".", "/");
  }
  load(entityOrId, done, fail) {
    const action = /* @__PURE__ */ __name(() => {
      if (entityOrId == null) {
        this.loadResponse({});
  ...
  loadEntity(entity) {
    ...
    this.entity = entity;
    (_a68 = this.propertyGrid) == null ? void 0 : _a68.set_mode(this.isEditMode() ? 2 /* update */ : 1 /* insert */);
    (_b = this.propertyGrid) == null ? void 0 : _b.load(entity);
  }
  beforeLoadEntity(entity) {
    var _a68;
    (_a68 = this.localizer) == null ? void 0 : _a68.clearValue();
  }
  afterLoadEntity() {
    this.updateInterface();
    this.updateTitle();
  }
  loadByIdAndOpenDialog(entityId, asPanel, callback, fail) {
    this.loadById(
      entityId,
  ...
  getLoadByIdOptions(id, callback) {
    return {
      ...
      onCleanup: /* @__PURE__ */ __name(() => this.validator != null && validatorAbortHandler(this.validator), "onCleanup")
    };
  }
  ...
  retrieveLocalizations() {
    return __async(this, null, function* () {
      const opt = __spreadProps(__spreadValues({}, this.getLoadByIdOptions(this.entityId, null)), {
        onSuccess: void 0,
        onCleanup: void 0
      });
      opt.request = __spreadProps(__spreadValues({}, opt.request), {
        ColumnSelection: 1 /* keyOnly */,
        IncludeColumns: ["Localizations"]
      });
      return (yield serviceCall(opt)).Localizations;
    });
  }
  getLocalizerOptions() {
    return {
      byId: /* @__PURE__ */ __name((id) => this.byId(id), "byId"),
      idPrefix: this.idPrefix,
      getButton: /* @__PURE__ */ __name(() => this.localizerButton, "getButton"),
      getEntity: /* @__PURE__ */ __name(() => this.entity, "getEntity"),
      getLanguages: /* @__PURE__ */ __name(() => this.getLanguages(), "getLanguages"),
      getPropertyGrid: /* @__PURE__ */ __name(() => this.byId("PropertyGrid"), "getPropertyGrid"),
      getToolButtons: /* @__PURE__ */ __name(() => this.toolbar.element.findAll(".tool-button"), "getToolButtons"),
      isNew: /* @__PURE__ */ __name(() => this.isNew(), "isNew"),
      pgOptions: this.getPropertyGridOptions(),
      retrieveLocalizations: /* @__PURE__ */ __name(() => this.retrieveLocalizations(), "retrieveLocalizations"),
      validateForm: /* @__PURE__ */ __name(() => this.validateForm(), "validateForm")
    };
  }
  initLocalizer() {
  ...
  getLanguages() {
    var _a68, _b;
    return ((_b = (_a68 = TranslationConfig).getLanguageList) == null ? void 0 : _b.call(_a68)) || [];
  }
  initPropertyGrid() {
  ...
  getPropertyItemsDataAsync() {
    return __async(this, null, function* () {
      const formKey = this.getFormKey();
      return formKey ? yield getFormDataAsync(formKey) : { items: [], additionalItems: [] };
    });
  }
  getPropertyGridOptions() {
    return {
  ...
  getSaveOptions(callback, initiator) {
    const opt = {};
  ...
  getSaveEntity() {
    ...
    (_a68 = this.propertyGrid) == null ? void 0 : _a68.save(entity);
    if (this.isEditMode()) {
      const idField = this.getIdProperty();
  ...
  saveHandler(options, callback, initiator) {
    serviceCall(options);
  }
  showSaveSuccessMessage(response, initiator) {
    notifySuccess(localText("Controls.EntityDialog.SaveSuccessMessage"), "", null);
  }
  getToolbarButtons() {
    return [
      saveAndCloseToolButton({
        onClick: /* @__PURE__ */ __name(() => this.save(() => this.dialogClose("save-and-close"), "save-and-close"), "onClick"),
        visible: /* @__PURE__ */ __name(() => !this.isDeleted() && !this.isViewMode(), "visible"),
        disabled: /* @__PURE__ */ __name(() => !this.hasSavePermission() || this.readOnly, "disabled"),
        ref: /* @__PURE__ */ __name((el) => this.saveAndCloseButton = Fluent(el), "ref")
      }),
      applyChangesToolButton({
        onClick: /* @__PURE__ */ __name(() => this.save((response) => {
          var _a68;
          return this.loadById(this.isEditMode() ? (_a68 = response == null ? void 0 : response.EntityId) != null ? _a68 : this.entityId : response == null ? void 0 : response.EntityId);
        }, "apply-changes"), "onClick"),
        visible: /* @__PURE__ */ __name(() => !this.isDeleted() && !this.isViewMode(), "visible"),
        disabled: /* @__PURE__ */ __name(() => !this.hasSavePermission() || this.readOnly, "disabled"),
        ref: /* @__PURE__ */ __name((el) => this.applyChangesButton = Fluent(el), "ref")
      }),
      deleteToolButton({
        onClick: /* @__PURE__ */ __name(() => confirmDialog(
          localText("Controls.EntityDialog.DeleteConfirmation"),
          () => this.doDelete(() => this.dialogClose("delete"))
        ), "onClick"),
        visible: /* @__PURE__ */ __name(() => this.isEditMode() && !this.isDeleted() && !this.isViewMode(), "visible"),
        disabled: /* @__PURE__ */ __name(() => !this.hasDeletePermission() || this.readOnly, "disabled"),
        ref: /* @__PURE__ */ __name((el) => this.deleteButton = Fluent(el), "ref")
      }),
      undeleteToolButton({
        onClick: /* @__PURE__ */ __name(() => this.isDeleted() && confirmDialog(localText("Controls.EntityDialog.UndeleteConfirmation"), () => this.undelete(() => this.loadById(this.entityId))), "onClick"),
        visible: /* @__PURE__ */ __name(() => this.isEditMode() && this.isDeleted() && !this.isViewMode(), "visible"),
        disabled: /* @__PURE__ */ __name(() => !this.hasDeletePermission() || this.readOnly, "disabled"),
        ref: /* @__PURE__ */ __name((el) => this.undeleteButton = Fluent(el), "ref")
      }),
      editToolButton({
        onClick: /* @__PURE__ */ __name(() => {
          if (!this.isEditMode())
        ...
        visible: /* @__PURE__ */ __name(() => this.isViewMode(), "visible"),
        disabled: /* @__PURE__ */ __name(() => !this.hasSavePermission() || this.readOnly, "disabled"),
        ref: /* @__PURE__ */ __name((el) => this.editButton = Fluent(el), "ref")
      }),
      localizationToolButton({
        onClick: /* @__PURE__ */ __name(() => {
          var _a68;
          return (_a68 = this.localizer) == null ? void 0 : _a68.buttonClick();
        }, "onClick"),
        visible: /* @__PURE__ */ __name(() => {
          var _a68;
          return (_a68 = this.localizer) == null ? void 0 : _a68.isEnabled();
        }, "visible"),
        ref: /* @__PURE__ */ __name((el) => this.localizerButton = Fluent(el), "ref")
      }),
      cloneToolButton({
        onClick: /* @__PURE__ */ __name(() => {
          if (!this.isEditMode())
        ...
        visible: /* @__PURE__ */ __name(() => false, "visible"),
        disabled: /* @__PURE__ */ __name(() => !this.hasInsertPermission() || this.readOnly, "disabled"),
        ref: /* @__PURE__ */ __name((el) => this.cloneButton = Fluent(el), "ref")
      })
    ];
  }
  getCloningEntity() {
    const clone = extend(new Object(), this.entity);
    const idField = this.getIdProperty();
    if (idField)
  ...
  updateInterface() {
    ...
    (_a68 = this.localizer) == null ? void 0 : _a68.updateInterface();
  ...
  undelete(callback) {
    const request = { EntityId: this.entityId };
    const options = extend({
  ...
  renderContents() {
    ...
    const id = this.useIdPrefix();
    return /* @__PURE__ */ jsx(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { id: id.Toolbar }),
      /* @__PURE__ */ jsx("div", { class: "s-Form", children: /* @__PURE__ */ jsx("form", { id: id.Form, action: "", children: /* @__PURE__ */ jsx("div", { id: id.PropertyGrid }) }) })
    ] });
  }
  static get defaultLanguageList() {
    var _a68, _b;
    return (_b = (_a68 = TranslationConfig).getLanguageList) == null ? void 0 : _b.call(_a68).map((x) => [x.id, x.text]);
  }
  static set defaultLanguageList(value) {
    TranslationConfig.getLanguageList = () => value == null ? void 0 : value.map((x) => ({ id: x[0], text: x[1] }));
  }
};
...
__name(_EntityDialog, "EntityDialog");
