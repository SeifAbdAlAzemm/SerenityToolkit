      ...
      canvases.forEach((canvas) => {
        if (this._jQuery) {
          ...
          canvas.addEventListener("mouseenter", (e) => {
            var _a, _b;
            return ((_b = (_a = e.target) == null ? void 0 : _a.classList) == null ? void 0 : _b.contains("slick-cell")) && this.handleMouseEnter(e);
          }, { capture: true });
          canvas.addEventListener("mouseleave", (e) => {
            var _a, _b;
            return ((_b = (_a = e.target) == null ? void 0 : _a.classList) == null ? void 0 : _b.contains("slick-cell")) && this.handleMouseLeave(e);
          }, { capture: true });
        }
      });
